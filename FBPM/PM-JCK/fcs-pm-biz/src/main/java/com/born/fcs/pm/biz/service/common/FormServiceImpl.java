...
//					//去重
//					Map<String, SimpleUserInfo> notifyUserMap = Maps.newHashMap();
//					if (ListUtil.isNotEmpty(notifyUserList)) {
//						for (SimpleUserInfo userInfo : notifyUserList) {
//							notifyUserMap.put(userInfo.getUserAccount(), userInfo);
//						}
//						notifyUserList.clear();
//						for (String key : notifyUserMap.keySet()) {
...
//	 * @param processTaskId
//	 */
//	private void setRelatedUser(FormInfo formInfo, long processManId, long processTaskId) {
//		try {
//			
//			//记录下步流程处理人员
...
//						continue;
//					
//					RelatedUserOrder relatedUser = new RelatedUserOrder();
...
//						
//						//记录流程处理人员
//						relatedUser.setUserType(RelatedUserTypeEnum.FLOW_PROCESS_MAN);
//						if (exeInfo.isSetAgent()) {
...
//									relatedUserService.setRelatedUser(relatedUser);
//								}
//							}
//						} else {
//							relatedUserService.setRelatedUser(relatedUser);
...
//						} else {
//							//记录流程候选人员
//							relatedUser.setUserType(RelatedUserTypeEnum.FLOW_CANDIDATE_MAN);
//							if (exeInfo.isSetAgent()) {
//								relatedUser.setRemark(exeInfo.getOpinion());
//							} else {
...
//				relatedUser.setUserType(RelatedUserTypeEnum.FLOW_SUBMIT_MAN);
...
//				BeanCopier.staticCopy(order, currentUser);
...
//						returnResult.setMessage("表单提交成功");
...
//					
//					//修改提交人的状态
//					relatedUserService.updateSubmitExeStatus(ExeStatusEnum.END_AGREE,
//						formInfo.getFormId());
//				}
//				
//				//设置流程处理人员
//				setRelatedUser(formInfo, order.getUserId(), order.getTaskId());
//				
...
//				
//				//更新任务执行状态
//				relatedUserService.updateExeStatus(ExeStatusEnum.EXCUTED, order.getVoteContent(),
//					order.getTaskId(), order.getUserId());
//				
//				return null;
//			}
//		});
...
//				
//				//更新未执行的任务
//				relatedUserService.deleteWhenCancel(formInfo.getFormId());
//				
//				return null;
//			}
//		});
...
//					
//					BeanCopier.staticCopy(form, formInfo);
//					formInfo.setStatus(FormStatusEnum.DENY);
//					
//					//设置执行轨迹
...
//				
//				//修改提交人的状态
//				relatedUserService.updateSubmitExeStatus(ExeStatusEnum.END_DISAGREE,
//					formInfo.getFormId());
//				
//				return null;
//			}
