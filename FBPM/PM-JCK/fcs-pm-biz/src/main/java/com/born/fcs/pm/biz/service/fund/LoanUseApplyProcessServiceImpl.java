...
public class LoanUseApplyProcessServiceImpl extends BaseProcessService {
	...
	public void endFlowProcess(FormInfo formInfo, WorkflowResult workflowResult) {
		...
		//			if (apply.getApplyType() == LoanUseApplyTypeEnum.LOAN) { //放款
		//				projectDO.getLoanedAmount().addTo(apply.getAmount());
		//			} else if (apply.getApplyType() == LoanUseApplyTypeEnum.USE) { //用款
		...
		FLoanUseApplyInfo apply = loanUseApplyService.queryByFormId(formInfo.getFormId());
		ProjectDO projectDO = projectDAO.findByProjectCode(apply.getProjectCode());
