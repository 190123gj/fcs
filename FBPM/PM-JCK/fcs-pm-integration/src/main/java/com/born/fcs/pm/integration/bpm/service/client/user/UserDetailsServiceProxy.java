...
public class UserDetailsServiceProxy implements com.born.fcs.pm.integration.bpm.service.client.user.UserDetailsService {
  ...
  private void _initUserDetailsServiceProxy() {
    try {
      userDetailsService = (new com.born.fcs.pm.integration.bpm.service.client.user.UserDetailsServiceImplServiceLocator()).getUserDetailsServiceImplPort();
