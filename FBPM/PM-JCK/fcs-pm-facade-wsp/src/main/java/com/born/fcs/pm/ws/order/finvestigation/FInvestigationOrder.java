 ...
 * 2016-3-8 下午2:00:20
 */
public class FInvestigationOrder extends ProjectFormOrderBase {
	...
	@Override
	public void check() {
//		validateHasText(investigatePlace, "调查地点");
//		validateNotNull(investigateDate, "调查日期");
//		validateHasText(investigatePersion, "现在调查人员");
//		validateHasText(receptionPersion, "客户接待人员");
	}
