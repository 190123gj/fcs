 ...
 *
 */
public class FCouncilSummaryProjectBondInfo extends FCouncilSummaryProjectCreditConditionInfo {
	
	private static final long serialVersionUID = -1455506965286274596L;
