...
public class ProjectRecoveryOrder extends ProcessOrder {
	...
	/** 追偿跟踪表 - 诉讼-诉前保全 */
	private ProjectRecoveryLitigationBeforePreservationOrder projectRecoveryLitigationBeforePreservationOrder;
	
	/** 追偿跟踪表 - 诉讼-立案 */
	private ProjectRecoveryLitigationPlaceOnFileOrder projectRecoveryLitigationPlaceOnFileOrder;
	
	/** 追偿跟踪表 - 诉讼-诉讼保全 */
	private ProjectRecoveryLitigationPreservationOrder projectRecoveryLitigationPreservationOrder;
	
	/** 追偿跟踪表 - 诉讼-庭前准备 */
	private ProjectRecoveryLitigationBeforeTrailOrder projectRecoveryLitigationBeforeTrailOrder;
	...
	/** 追偿跟踪表 - 诉讼-实现担保物权特别程序 */
	private ProjectRecoveryLitigationSpecialProcedureOrder projectRecoveryLitigationSpecialProcedureOrder;
	
	/** 追偿跟踪表 - 诉讼-强制执行公证执行证书 */
	private ProjectRecoveryLitigationCertificateOrder projectRecoveryLitigationCertificateOrder;
	
	/** 追偿跟踪表 - 诉讼-执行 */
	private ProjectRecoveryLitigationExecuteOrder projectRecoveryLitigationExecuteOrder;
	
	/** 追偿跟踪表 - 诉讼-再审程序-一审 */
	private List<ProjectRecoveryLitigationAdjournedProcedureOrder> projectRecoveryLitigationAdjournedProcedureOrder;
	
	/** 追偿跟踪表 - 诉讼-再审程序-二审 */
	private ProjectRecoveryLitigationAdjournedSecondOrder projectRecoveryLitigationAdjournedSecondOrder;
	
	/** 追偿跟踪表 - 诉讼-执行回转 */
	private ProjectRecoveryLitigationExecuteGyrationOrder projectRecoveryLitigationExecuteGyrationOrder;
	...
	public ProjectRecoveryLitigationBeforePreservationOrder getProjectRecoveryLitigationBeforePreservationOrder() {
		return this.projectRecoveryLitigationBeforePreservationOrder;
	}
	
	public ProjectRecoveryLitigationAdjournedSecondOrder getProjectRecoveryLitigationAdjournedSecondOrder() {
		return this.projectRecoveryLitigationAdjournedSecondOrder;
	}
	
	public void setProjectRecoveryLitigationAdjournedSecondOrder(	ProjectRecoveryLitigationAdjournedSecondOrder projectRecoveryLitigationAdjournedSecondOrder) {
		this.projectRecoveryLitigationAdjournedSecondOrder = projectRecoveryLitigationAdjournedSecondOrder;
	}
	
	public void setProjectRecoveryLitigationBeforePreservationOrder(ProjectRecoveryLitigationBeforePreservationOrder projectRecoveryLitigationBeforePreservationOrder) {
		this.projectRecoveryLitigationBeforePreservationOrder = projectRecoveryLitigationBeforePreservationOrder;
	}
	
	public ProjectRecoveryLitigationPlaceOnFileOrder getProjectRecoveryLitigationPlaceOnFileOrder() {
		return this.projectRecoveryLitigationPlaceOnFileOrder;
	}
	
	public void setProjectRecoveryLitigationPlaceOnFileOrder(	ProjectRecoveryLitigationPlaceOnFileOrder projectRecoveryLitigationPlaceOnFileOrder) {
		this.projectRecoveryLitigationPlaceOnFileOrder = projectRecoveryLitigationPlaceOnFileOrder;
	}
	
	public ProjectRecoveryLitigationPreservationOrder getProjectRecoveryLitigationPreservationOrder() {
		return this.projectRecoveryLitigationPreservationOrder;
	}
	
	public void setProjectRecoveryLitigationPreservationOrder(	ProjectRecoveryLitigationPreservationOrder projectRecoveryLitigationPreservationOrder) {
		this.projectRecoveryLitigationPreservationOrder = projectRecoveryLitigationPreservationOrder;
	}
	
	public ProjectRecoveryLitigationBeforeTrailOrder getProjectRecoveryLitigationBeforeTrailOrder() {
		return this.projectRecoveryLitigationBeforeTrailOrder;
	}
	
	public void setProjectRecoveryLitigationBeforeTrailOrder(	ProjectRecoveryLitigationBeforeTrailOrder projectRecoveryLitigationBeforeTrailOrder) {
	...
	public ProjectRecoveryLitigationSpecialProcedureOrder getProjectRecoveryLitigationSpecialProcedureOrder() {
		return this.projectRecoveryLitigationSpecialProcedureOrder;
	}
	
	public void setProjectRecoveryLitigationSpecialProcedureOrder(	ProjectRecoveryLitigationSpecialProcedureOrder projectRecoveryLitigationSpecialProcedureOrder) {
		this.projectRecoveryLitigationSpecialProcedureOrder = projectRecoveryLitigationSpecialProcedureOrder;
	}
	
	public ProjectRecoveryLitigationCertificateOrder getProjectRecoveryLitigationCertificateOrder() {
		return this.projectRecoveryLitigationCertificateOrder;
	}
	
	public void setProjectRecoveryLitigationCertificateOrder(	ProjectRecoveryLitigationCertificateOrder projectRecoveryLitigationCertificateOrder) {
		this.projectRecoveryLitigationCertificateOrder = projectRecoveryLitigationCertificateOrder;
	}
	
	public ProjectRecoveryLitigationExecuteOrder getProjectRecoveryLitigationExecuteOrder() {
		return this.projectRecoveryLitigationExecuteOrder;
	}
	
	public void setProjectRecoveryLitigationExecuteOrder(	ProjectRecoveryLitigationExecuteOrder projectRecoveryLitigationExecuteOrder) {
	...
	public ProjectRecoveryLitigationExecuteGyrationOrder getProjectRecoveryLitigationExecuteGyrationOrder() {
		return this.projectRecoveryLitigationExecuteGyrationOrder;
	}
	
	public void setProjectRecoveryLitigationExecuteGyrationOrder(	ProjectRecoveryLitigationExecuteGyrationOrder projectRecoveryLitigationExecuteGyrationOrder) {
