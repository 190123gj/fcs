...
public class FInvestigationMainlyReviewAssetAndLiabilityOrder extends ValidateOrderBase {
	...
	public boolean isNull() {
		return isNull(name)
				...
				&& isNull(houseNum)
				&& isNull(carNum)
				&& isNull(investAmountStr)
				&& isNull(investAmountStr)
				&& isNull(depositAmountStr)
				&& isNull(maritalStatus)
				&& isNull(spouseName)
				&& isNull(spouseCertType)
				&& isNull(spouseCertNo)
				&& isNull(spouseContactNo)
				&& isNull(spouseAddress)
				&& isNull(spouseImmovableProperty)
				&& isNull(spouseMovableProperty)
				&& isNull(hasBankLoan)
				&& isNull(hasFolkLoan)
				&& isNull(bankLoanAmountStr)
				&& isNull(folkLoanAmountStr)
				&& isNull(consumerLoanBank)
				&& isNull(consumerLoanAmountStr)
				&& isNull(consumerLoanStartDate)
				&& isNull(consumerLoanEndDate)
				&& isNull(businesLoanBank)
				&& isNull(businesLoanAmountStr)
				&& isNull(businesLoanStartDate)
				&& isNull(businesLoanEndDate)
				&& isNull(mortgageLoanBank)
				&& isNull(mortgageLoanAmountStr)
				&& isNull(mortgageLoanStartDate)
				&& isNull(mortgageLoanEndDate)
				;
	}
	//========== getters and setters ==========
	...
	public Money getInvestAmount() {
		if(isNull(this.investAmountStr)) {
			return new Money(0L);
		}
		return Money.amout(this.investAmountStr);
	}
	...
	public Money getDepositAmount() {
		if(isNull(this.depositAmountStr)) {
			return new Money(0L);
		}
		return Money.amout(this.depositAmountStr);
	}
