 ...
 * 2016-3-10 下午5:58:07
 */
public class FInvestigationCsRationalityReviewInfo extends SimpleFormProjectInfo {
...
//	private List<FInvestigationCsRationalityReviewFinancialKpiInfo> kpies;
	...
	public FInvestigationReviewBaseInfo getReviewBaseInfo() {
		return reviewBaseInfo;
	}
	
	public void setReviewBaseInfo(FInvestigationReviewBaseInfo reviewBaseInfo) {
	...
	public List<InvestigationFinancialKpiInfo> getKpies() {
		return kpies;
	}
	
	public void setKpies(List<InvestigationFinancialKpiInfo> kpies) {
		this.kpies = kpies;
	}
	...
	public FInvestigationMainlyReviewInfo getMainlyReview() {
		return mainlyReview;
	}
	
	public void setMainlyReview(FInvestigationMainlyReviewInfo mainlyReview) {
		this.mainlyReview = mainlyReview;
	}

	public InvestigationFinancialKpiInfo getHeader() {
		return header;
	}

	public void setHeader(InvestigationFinancialKpiInfo header) {
		this.header = header;
	}
