...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.FFinancialKpiDAO</tt>.
 *
...
public class IbatisFFinancialKpiDAO extends SqlMapClientDaoSupport implements FFinancialKpiDAO {
	/**
    ...
    public long insert(FFinancialKpiDO FFinancialKpi) throws DataAccessException {
    	if (FFinancialKpi == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-F-FINANCIAL-KPI-INSERT", FFinancialKpi);

        return FFinancialKpi.getKpiId();
    }
    ...
    public int update(FFinancialKpiDO FFinancialKpi) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-F-FINANCIAL-KPI-UPDATE", FFinancialKpi);
    }
    ...
    public FFinancialKpiDO findById(long kpiId) throws DataAccessException {
        Long param = new Long(kpiId);

        return (FFinancialKpiDO) getSqlMapClientTemplate().queryForObject("MS-F-FINANCIAL-KPI-FIND-BY-ID", param);
    ...
    public List<FFinancialKpiDO> findByFormId(long formId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-FINANCIAL-KPI-FIND-BY-FORM-ID", param);
    ...
    public List<FFinancialKpiDO> findByFormIdAndKpitype(long formId, String kpiType) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-FINANCIAL-KPI-FIND-BY-FORM-ID-AND-KPITYPE", param);
    ...
    public List<FFinancialKpiDO> findByParentId(long parentId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-FINANCIAL-KPI-FIND-BY-PARENT-ID", param);
    ...
    public int deleteById(long kpiId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-FINANCIAL-KPI-DELETE-BY-ID", param);
    }
    ...
    public int deleteByFormId(long formId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-FINANCIAL-KPI-DELETE-BY-FORM-ID", param);
    }
    ...
    public int deleteByParentId(long parentId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-FINANCIAL-KPI-DELETE-BY-PARENT-ID", param);
    }
    ...
    public int deleteByFormIdAndKpitype(long formId, String kpiType) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-FINANCIAL-KPI-DELETE-BY-FORM-ID-AND-KPITYPE", param);
    }
    ...
    public List<FFinancialKpiDO> findByCondition(FFinancialKpiDO FFinancialKpi, long limitStart, long pageSize) throws DataAccessException {
        ...
        param.put("FFinancialKpi", FFinancialKpi);
        param.put("limitStart", new Long(limitStart));
        param.put("pageSize", new Long(pageSize));

        return getSqlMapClientTemplate().queryForList("MS-F-FINANCIAL-KPI-FIND-BY-CONDITION", param);
    ...
    public long findByConditionCount(FFinancialKpiDO FFinancialKpi) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-F-FINANCIAL-KPI-FIND-BY-CONDITION-COUNT", FFinancialKpi);
