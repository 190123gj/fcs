...
public class IbatisFReCouncilApplyDAO extends SqlMapClientDaoSupport implements FReCouncilApplyDAO {
	 ...
	 *  <tt>insert into f_re_council_apply(id,form_id,project_code,old_sp_id,old_sp_code,content_reason,overview,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_re_council_apply set form_id=?, project_code=?, old_sp_id=?, old_sp_code=?, content_reason=?, overview=? where (id = ?)</tt>
	 *
	 *	@param FReCouncilApply
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_re_council_apply set project_code=?, old_sp_id=?, old_sp_code=?, content_reason=?, overview=? where (form_id = ?)</tt>
	 *
	 *	@param FReCouncilApply
	 *	@return int
	 *	@throws DataAccessException
