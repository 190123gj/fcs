...
/**
 * A dao interface provides methods to access database table <tt>project_recovery_debtor_reorganization</tt>.
 *
...
public interface ProjectRecoveryDebtorReorganizationDAO {
	/**
