...
/**
 * A dao interface provides methods to access database table <tt>project_recovery_litigation_execute_gyration</tt>.
 *
...
public interface ProjectRecoveryLitigationExecuteGyrationDAO {
	/**
	 ...
	 *  <tt>insert into project_recovery_litigation_execute_gyration(project_recovery_id,memo,raw_add_time) values (?, ?, ?)</tt>
	 *
	 ...
	 *	@throws DataAccessException
	 */	 
    public ProjectRecoveryLitigationExecuteGyrationDO findByRecoveryId(long projectRecoveryId) throws DataAccessException;
