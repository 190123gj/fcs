...
public class FCouncilSummaryRiskHandleDO implements Serializable{
	...
	public void setCompInterest(Money compInterest) {
		if (compInterest == null) {
			this.compInterest = new Money(0, 0);
		} else {
	...
	public void setCompPenalty(Money compPenalty) {
		if (compPenalty == null) {
			this.compPenalty = new Money(0, 0);
		} else {
	...
	public void setCompPenaltyInterest(Money compPenaltyInterest) {
		if (compPenaltyInterest == null) {
			this.compPenaltyInterest = new Money(0, 0);
		} else {
