...
/**
 * A dao interface provides methods to access database table <tt>f_project_financial_tansfer_apply</tt>.
 *
...
public interface FProjectFinancialTansferApplyDAO {
	/**
	 ...
	 *  <tt>insert into f_project_financial_tansfer_apply(apply_id,form_id,project_code,hold_num,transfering_num,redeeming_num,transfer_price,transfer_num,transfer_time_start,transfer_time_end,transfer_reason,attach,is_transfer_ownership,is_buy_back,buy_back_price,buy_back_time,council_type,council_apply_id,council_status,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_project_financial_tansfer_apply set form_id=?, project_code=?, hold_num=?, transfering_num=?, redeeming_num=?, transfer_price=?, transfer_num=?, transfer_time_start=?, transfer_time_end=?, transfer_reason=?, attach=?, is_transfer_ownership=?, is_buy_back=?, buy_back_price=?, buy_back_time=?, council_type=?, council_apply_id=?, council_status=? where (apply_id = ?)</tt>
	 *
	 *	@param FProjectFinancialTansferApply
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select * from f_project_financial_tansfer_apply where (p.council_status = 'COUNCIL_WAITING')</tt>
	 *
	 *	@param limit
	 *	@return List<FProjectFinancialTansferApplyDO>
	 *	@throws DataAccessException
