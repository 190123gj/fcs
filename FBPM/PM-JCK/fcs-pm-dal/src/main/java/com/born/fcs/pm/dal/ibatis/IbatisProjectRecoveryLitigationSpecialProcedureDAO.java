...
public class IbatisProjectRecoveryLitigationSpecialProcedureDAO extends SqlMapClientDaoSupport implements ProjectRecoveryLitigationSpecialProcedureDAO {
    ...
    public ProjectRecoveryLitigationSpecialProcedureDO findByRecoveryId(long projectRecoveryId) throws DataAccessException {
        ...
        return (ProjectRecoveryLitigationSpecialProcedureDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-RECOVERY-LITIGATION-SPECIAL-PROCEDURE-FIND-BY-RECOVERY-ID", param);
