...
/**
 * A dao interface provides methods to access database table <tt>f_project_financial</tt>.
 *
...
public interface FProjectFinancialDAO {
	/**
	 *  Insert one <tt>FProjectFinancialDO</tt> object to DB table <tt>f_project_financial</tt>, return primary key
	 *
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>insert into f_project_financial(id,form_id,project_code,product_id,product_type,product_name,interest_type,term_type,time_limit,time_unit,issue_institution,interest_rate,interest_settlement_way,expect_buy_date,expect_expire_date,price,buy_num,risk_level,risk_measure,attach_name,attach_url,create_user_id,create_user_account,create_user_name,dept_id,dept_code,dept_name,dept_path,dept_path_name,council_type,council_apply_id,council_status,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_project_financial set form_id=?, project_code=?, product_id=?, product_type=?, product_name=?, interest_type=?, term_type=?, time_limit=?, time_unit=?, issue_institution=?, interest_rate=?, interest_settlement_way=?, expect_buy_date=?, expect_expire_date=?, price=?, buy_num=?, risk_level=?, risk_measure=?, attach_name=?, attach_url=?, create_user_id=?, create_user_account=?, create_user_name=?, dept_id=?, dept_code=?, dept_name=?, dept_path=?, dept_path_name=?, council_type=?, council_apply_id=?, council_status=? where (id = ?)</tt>
	 *
	 *	@param FProjectFinancial
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_project_financial set project_code=?, product_id=?, product_type=?, product_name=?, interest_type=?, term_type=?, time_limit=?, time_unit=?, issue_institution=?, interest_rate=?, interest_settlement_way=?, expect_buy_date=?, expect_expire_date=?, price=?, buy_num=?, risk_level=?, risk_measure=?, attach_name=?, attach_url=?, create_user_id=?, create_user_account=?, create_user_name=?, dept_id=?, dept_code=?, dept_name=?, dept_path=?, dept_path_name=?, council_type=?, council_apply_id=?, council_status=? where (form_id = ?)</tt>
	 *
	 *	@param FProjectFinancial
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select * from f_project_financial where (p.council_status = 'COUNCIL_WAITING')</tt>
	 *
	 *	@param limit
