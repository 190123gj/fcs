...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.SysParamDAO</tt>.
 *
...
public class IbatisSysParamDAO extends SqlMapClientDaoSupport implements SysParamDAO {
    ...
    public long paramInfoQueryCount(SysParamDO sysParam) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-SYS-PARAM-PARAM-INFO-QUERY-COUNT", sysParam);
    ...
    public int updateAutoTest(SysParamDO sysParam) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-SYS-PARAM-UPDATE-AUTO-TEST", sysParam);
    }
