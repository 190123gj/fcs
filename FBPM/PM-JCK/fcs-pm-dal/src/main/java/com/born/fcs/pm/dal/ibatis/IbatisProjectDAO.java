...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.ProjectDAO</tt>.
 *
...
public class IbatisProjectDAO extends SqlMapClientDaoSupport implements ProjectDAO {
    ...
    public ProjectDO findByIdForUpdate(long projectId) throws DataAccessException {
        ...
        return (ProjectDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-FIND-BY-ID-FOR-UPDATE", param);
    ...
    public ProjectDO findByProjectCode(String projectCode) throws DataAccessException {
        ...
        return (ProjectDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-FIND-BY-PROJECT-CODE", projectCode);
    ...
    public ProjectDO findByProjectCodeForUpdate(String projectCode) throws DataAccessException {
        ...
        return (ProjectDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-FIND-BY-PROJECT-CODE-FOR-UPDATE", projectCode);
	 ...
	 *	@throws DataAccessException
	 */	 
    public long findByConditionCount(ProjectDO project, String projectCodeOrName, long loginUserId, String hasLoanAmount, String hasUseAmount, String hasBothAmount, String hasChargeAmount, String hasIssueAmount, String hasCompensatoryAmount, String dockFormType, String isReleasing, List busiTypeList, List deptIdList, List phases, List phasesStatus, List status, Date approvalTimeStart, Date approvalTimeEnd, String hasContract, Date contractTimeStart, Date contractTimeEnd, String recoverySelecterId, List relatedRoleList) throws DataAccessException {
    	if (project == null) {
    		throw new IllegalArgumentException("Can't select by a null data object.");
    	}
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-PROJECT-FIND-BY-CONDITION-COUNT", param);
    ...
    public List<ProjectDO> findCountGroupByPhases() throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-PROJECT-FIND-COUNT-GROUP-BY-PHASES", null);
