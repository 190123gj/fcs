...
import com.born.fcs.pm.dal.daointerface.ProjectExtendInfoDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.ProjectExtendInfoDAO</tt>.
 *
...
public class IbatisProjectExtendInfoDAO extends SqlMapClientDaoSupport implements ProjectExtendInfoDAO {
	/**
    ...
    public long insert(ProjectExtendInfoDO projectExtendInfo) throws DataAccessException {
        ...
        getSqlMapClientTemplate().insert("MS-PROJECT-EXTEND-INFO-INSERT", projectExtendInfo);

        return projectExtendInfo.getExtendId();
    }
    ...
    public int update(ProjectExtendInfoDO projectExtendInfo) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-PROJECT-EXTEND-INFO-UPDATE", projectExtendInfo);
    }
    ...
    public ProjectExtendInfoDO findById(long extendId) throws DataAccessException {
        Long param = new Long(extendId);

        return (ProjectExtendInfoDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-EXTEND-INFO-FIND-BY-ID", param);
    ...
    public List<ProjectExtendInfoDO> findByProjectCodeAndProperty(String projectCode, String property) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-PROJECT-EXTEND-INFO-FIND-BY-PROJECT-CODE-AND-PROPERTY", param);
    ...
    public ProjectExtendInfoDO findByFormId(long formId) throws DataAccessException {
        ...
        return (ProjectExtendInfoDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-EXTEND-INFO-FIND-BY-FORM-ID", param);
    ...
    public int deleteById(long extendId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-PROJECT-EXTEND-INFO-DELETE-BY-ID", param);
    }
    ...
    public int deleteByProjectCode(String projectCode) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-PROJECT-EXTEND-INFO-DELETE-BY-PROJECT-CODE", projectCode);
    }
    ...
    public int deleteByProjectCodeAndProperty(String projectCode, String property) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-PROJECT-EXTEND-INFO-DELETE-BY-PROJECT-CODE-AND-PROPERTY", param);
    }
    ...
    public List<ProjectExtendInfoDO> findByCondition(ProjectExtendInfoDO projectExtendInfo, long loginUserId, List deptIdList, String sortCol, String sortOrder, long limitStart, long pageSize) throws DataAccessException {
        ...
        param.put("projectExtendInfo", projectExtendInfo);
        ...
        return getSqlMapClientTemplate().queryForList("MS-PROJECT-EXTEND-INFO-FIND-BY-CONDITION", param);
    ...
    public long findByConditionCount(ProjectExtendInfoDO projectExtendInfo, long loginUserId, List deptIdList) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-PROJECT-EXTEND-INFO-FIND-BY-CONDITION-COUNT", param);
