...
public interface FCounterGuaranteeReleaseDAO {
	 ...
	 *  <tt>insert into f_counter_guarantee_release(form_id,project_code,project_name,customer_id,customer_name,contract_number,credit_amount,time_limit,time_unit,busi_type,busi_type_name,remark,released_amount,releasing_amount,apply_amount,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_counter_guarantee_release set form_id=?, project_code=?, project_name=?, customer_id=?, customer_name=?, contract_number=?, credit_amount=?, time_limit=?, time_unit=?, busi_type=?, busi_type_name=?, remark=?, released_amount=?, releasing_amount=?, apply_amount=? where (id = ?)</tt>
	 *
	 *	@param FCounterGuaranteeRelease
	 *	@return int
	 *	@throws DataAccessException
