...
import com.born.fcs.pm.dal.daointerface.ConsentIssueNoticeDAO;
// auto generated imports
import com.born.fcs.pm.dal.dataobject.ConsentIssueNoticeDO;

/**
 * An ibatis based implementation of dao interface
 * <tt>com.born.fcs.pm.dal.daointerface.ConsentIssueNoticeDAO</tt>.
 *
...
public class IbatisConsentIssueNoticeDAO extends SqlMapClientDaoSupport implements
																		ConsentIssueNoticeDAO {
	/**
	 * Insert one <tt>ConsentIssueNoticeDO</tt> object to DB table
	 * <tt>consent_issue_notice</tt>, return primary key
	 *
	 * <p>
	...
	public long insert(ConsentIssueNoticeDO consentIssueNotice) throws DataAccessException {
		if (consentIssueNotice == null) {
			throw new IllegalArgumentException("Can't insert a null data object into db.");
		}
		
		getSqlMapClientTemplate().insert("MS-CONSENT-ISSUE-NOTICE-INSERT", consentIssueNotice);
		
		return consentIssueNotice.getNoticeId();
	}
	...
	public int update(ConsentIssueNoticeDO consentIssueNotice) throws DataAccessException {
		...
		return getSqlMapClientTemplate().update("MS-CONSENT-ISSUE-NOTICE-UPDATE",
			consentIssueNotice);
	}
	...
	public ConsentIssueNoticeDO findById(long noticeId) throws DataAccessException {
		Long param = new Long(noticeId);
		
		return (ConsentIssueNoticeDO) getSqlMapClientTemplate().queryForObject(
			"MS-CONSENT-ISSUE-NOTICE-FIND-BY-ID", param);
	...
	public int deleteById(long noticeId) throws DataAccessException {
		...
		return getSqlMapClientTemplate().delete("MS-CONSENT-ISSUE-NOTICE-DELETE-BY-ID", param);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<ConsentIssueNoticeDO> findByCondition(ConsentIssueNoticeDO consentIssueNotice,
		...
		param.put("consentIssueNotice", consentIssueNotice);
		param.put("limitStart", new Long(limitStart));
		param.put("pageSize", new Long(pageSize));
		
		return getSqlMapClientTemplate().queryForList("MS-CONSENT-ISSUE-NOTICE-FIND-BY-CONDITION",
			param);
	 ...
	 * @throws DataAccessException
	 */
	public long findByConditionCount(ConsentIssueNoticeDO consentIssueNotice)
																				throws DataAccessException {
		if (consentIssueNotice == null) {
			throw new IllegalArgumentException("Can't select by a null data object.");
		}
		...
		Long retObj = (Long) getSqlMapClientTemplate().queryForObject(
			"MS-CONSENT-ISSUE-NOTICE-FIND-BY-CONDITION-COUNT", param);
