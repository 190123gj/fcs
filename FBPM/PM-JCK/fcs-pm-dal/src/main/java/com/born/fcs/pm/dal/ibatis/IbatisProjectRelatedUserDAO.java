...
import com.born.fcs.pm.dal.daointerface.ProjectRelatedUserDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.ProjectRelatedUserDAO</tt>.
 *
...
public class IbatisProjectRelatedUserDAO extends SqlMapClientDaoSupport implements ProjectRelatedUserDAO {
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>delete from project_related_user where ((project_code = ?) AND (user_type = 'COUNCIL_JUDGE') AND (remark = ?))</tt>
	 *
	 *	@param projectCode
	 *	@param remark
	 *	@return int
	 *	@throws DataAccessException
	 */	 
    public int deleteCoucilJudges(String projectCode, String remark) throws DataAccessException {
        Map param = new HashMap();

        param.put("projectCode", projectCode);
        param.put("remark", remark);

        return getSqlMapClientTemplate().delete("MS-PROJECT-RELATED-USER-DELETE-COUCIL-JUDGES", param);
    }
