...
public class IbatisProjectRecoveryLitigationCertificateDAO extends SqlMapClientDaoSupport implements ProjectRecoveryLitigationCertificateDAO {
    ...
    public ProjectRecoveryLitigationCertificateDO findByRecoveryId(long projectRecoveryId) throws DataAccessException {
        ...
        return (ProjectRecoveryLitigationCertificateDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-RECOVERY-LITIGATION-CERTIFICATE-FIND-BY-RECOVERY-ID", param);
