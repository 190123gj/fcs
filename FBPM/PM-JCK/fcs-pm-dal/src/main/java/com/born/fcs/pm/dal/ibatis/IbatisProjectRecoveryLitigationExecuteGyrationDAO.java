...
public class IbatisProjectRecoveryLitigationExecuteGyrationDAO extends SqlMapClientDaoSupport implements ProjectRecoveryLitigationExecuteGyrationDAO {
    ...
    public ProjectRecoveryLitigationExecuteGyrationDO findByRecoveryId(long projectRecoveryId) throws DataAccessException {
        ...
        return (ProjectRecoveryLitigationExecuteGyrationDO) getSqlMapClientTemplate().queryForObject("MS-PROJECT-RECOVERY-LITIGATION-EXECUTE-GYRATION-FIND-BY-RECOVERY-ID", param);
