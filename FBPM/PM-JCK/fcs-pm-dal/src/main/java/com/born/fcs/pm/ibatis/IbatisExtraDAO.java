...
public class IbatisExtraDAO extends SqlMapClientDaoSupport implements ExtraDAO {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<ProjectDO> selectLoanUseApplyProject(ProjectDO queryCondition, long loginUserId,
	...
	@Override
	public long selectLoanUseApplyProjectCount(ProjectDO queryCondition, long loginUserId,
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<AfterwardsProjectSummaryDO> searchSummaryLoanedAmount(	AfterwardsProjectSummaryDO summaryDO)
																												throws DataAccessException {
		if (summaryDO == null) {
			throw new IllegalArgumentException("setupForm can`t by null");
		}
		...
		List<AfterwardsProjectSummaryDO> list = getSqlMapClientTemplate().queryForList(
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<AfterwardsProjectSummaryDO> searchSummaryApplyAmount(	AfterwardsProjectSummaryDO summaryDO)
																												throws DataAccessException {
		if (summaryDO == null) {
			throw new IllegalArgumentException("setupForm can`t by null");
		}
	...
	@Override
	public long searchSummaryCount(AfterwardsProjectSummaryDO summaryDO) throws DataAccessException {
		if (summaryDO == null) {
			throw new IllegalArgumentException("setupForm can`t by null");
		}
	...
	@Override
	public long queryCheckReportIncomeFormId(String projectCode) throws DataAccessException {
		Long formId = (Long) getSqlMapClientTemplate().queryForObject(
			"MS-EXTRA-CHECK-REPORT-INCOME-FORMID", projectCode);
		return null == formId ? 0L : formId.longValue();
	}
	...
	@Override
	public FAfterwardsCheckDO searchAfterCheckEdition(String projectCode)
																			throws DataAccessException {
		Object obj = getSqlMapClientTemplate().queryForObject(
			"MS-EXTRA-AFTER-CHECK-LATEST-EDITION-SEARCH", projectCode);
		if (null != obj) {
