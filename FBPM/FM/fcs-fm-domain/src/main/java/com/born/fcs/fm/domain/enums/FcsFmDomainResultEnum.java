 ...
 */
package com.born.fcs.fm.domain.enums;
 ...
 *
 */
public enum FcsFmDomainResultEnum {
	 ...
	 * @param message
	 */
	private FcsFmDomainResultEnum(String code, String message) {
		this.code = code;
	 ...
	 */
	public static FcsFmDomainResultEnum getByCode(String code) {
		for (FcsFmDomainResultEnum _enum : values()) {
	 ...
	 */
	public List<FcsFmDomainResultEnum> getAllEnum() {
		List<FcsFmDomainResultEnum> list = new ArrayList<FcsFmDomainResultEnum>();
		for (FcsFmDomainResultEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
