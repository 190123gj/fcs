...
public class UserDetailsServiceImplServiceLocator extends org.apache.axis.client.Service
																						implements
																						com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsServiceImplService {
	...
	public UserDetailsServiceImplServiceLocator(java.lang.String wsdlLoc,
	...
	public com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsService getUserDetailsServiceImplPort()
																													throws javax.xml.rpc.ServiceException {
	...
	public com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsService getUserDetailsServiceImplPort(java.net.URL portAddress)
																																			throws javax.xml.rpc.ServiceException {
		try {
			com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub _stub = new com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub(
				portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
																	throws javax.xml.rpc.ServiceException {
		try {
			if (com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsService.class
				.isAssignableFrom(serviceEndpointInterface)) {
				com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub _stub = new com.born.fcs.fm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub(
					new java.net.URL(UserDetailsServiceImplPort_address), this);
				_stub.setPortName(getUserDetailsServiceImplPortWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://impl.webservice.platform.gcdata.com/",
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://impl.webservice.platform.gcdata.com/",
				"UserDetailsServiceImplPort"));
		}
