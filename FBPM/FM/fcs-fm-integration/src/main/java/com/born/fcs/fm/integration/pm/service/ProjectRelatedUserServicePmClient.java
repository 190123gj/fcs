...
public class ProjectRelatedUserServicePmClient extends ClientAutowiredBaseService implements
	...
	@Override
	public FcsBaseResult setCouncilJudges(final String projectCode,final  List<Long> judgeIds,final long councilId) {
		return callInterface(new CallExternalInterface<FcsBaseResult>() {
			
			@Override
			public FcsBaseResult call() {
				return projectRelatedUserPmWebService.setCouncilJudges(projectCode,judgeIds,councilId);
			}
		});
	}
