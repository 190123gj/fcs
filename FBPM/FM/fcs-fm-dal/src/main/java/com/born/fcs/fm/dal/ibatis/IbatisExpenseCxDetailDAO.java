...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.fm.dal.daointerface.ExpenseCxDetailDAO</tt>.
 *
...
public class IbatisExpenseCxDetailDAO extends SqlMapClientDaoSupport implements ExpenseCxDetailDAO {
	/**
    ...
    public long insert(ExpenseCxDetailDO expenseCxDetail) throws DataAccessException {
    	if (expenseCxDetail == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-EXPENSE-CX-DETAIL-INSERT", expenseCxDetail);

        return expenseCxDetail.getDetailId();
    }
    ...
    public int update(ExpenseCxDetailDO expenseCxDetail) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-EXPENSE-CX-DETAIL-UPDATE", expenseCxDetail);
    }
    ...
    public ExpenseCxDetailDO findById(long detailId) throws DataAccessException {
        ...
        return (ExpenseCxDetailDO) getSqlMapClientTemplate().queryForObject("MS-EXPENSE-CX-DETAIL-FIND-BY-ID", param);
    ...
    public int deleteById(long detailId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-EXPENSE-CX-DETAIL-DELETE-BY-ID", param);
    }
    ...
    public List<ExpenseCxDetailDO> findByExpenseId(Long expenseId, Long fromApplicationId, Long fromDetailId) throws DataAccessException {
        ...
        param.put("fromApplicationId", fromApplicationId);
        param.put("fromDetailId", fromDetailId);

        return getSqlMapClientTemplate().queryForList("MS-EXPENSE-CX-DETAIL-FIND-BY-EXPENSE-ID", param);
