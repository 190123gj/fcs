...
public class FormExpenseApplicationInfo extends FormVOInfo {
	...
	public List<ExpenseCxDetailInfo> getCxdetailList() {
		return cxdetailList;
	}
	
	public void setCxdetailList(List<ExpenseCxDetailInfo> cxdetailList) {
	...
	public List<FormExpenseApplicationDetailInfo> getDetailList() {
		return detailList;
	}
	
	public void setDetailList(List<FormExpenseApplicationDetailInfo> detailList) {
