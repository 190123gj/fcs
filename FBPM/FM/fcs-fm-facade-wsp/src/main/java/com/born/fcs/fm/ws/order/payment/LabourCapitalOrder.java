...
public class LabourCapitalOrder extends FormOrderBase {
	...
	private List<LabourCapitalDetailOrder> detailList;
	...
	public void check() {
		...
		for (LabourCapitalDetailOrder detailOrder : detailList) {
			detailOrder.check();
		}
	}
	...
	public List<LabourCapitalDetailOrder> getDetailList() {
		return this.detailList;
	}
	
	public void setDetailList(List<LabourCapitalDetailOrder> detailList) {
