...
public class SmsSendQueryResult extends BornResultBase {
	/**
	 */
	...
	private List<SmsInfo> dataList = null;
	...
	public List<SmsInfo> getDataList() {
		return dataList;
	}

	public void setDataList(List<SmsInfo> dataList) {
