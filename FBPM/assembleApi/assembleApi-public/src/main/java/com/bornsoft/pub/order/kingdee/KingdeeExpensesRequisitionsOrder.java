 ...
 * @date         2016-9-1 上午9:44:49
 * @version:     v1.0
 */
public class KingdeeExpensesRequisitionsOrder extends BornOrderBase {
	...
	/** 详情 **/
	private List<ExpensesRequisitionsInfo> feeDetail;
	...
	public List<ExpensesRequisitionsInfo> getFeeDetail() {
		return feeDetail;
	}

	public void setFeeDetail(List<ExpensesRequisitionsInfo> feeDetail) {
	 ...
	 * @Description: 
	 * @author:      xiaohui@yiji.com
	 * @date         2016-9-1 上午9:50:28
	 * @version:     v1.0
	 */
	public static class ExpensesRequisitionsInfo extends BornInfoBase{
		/** 费用种类 **/
