...
public class SysUser extends com.born.fcs.pm.integration.bpm.service.client.user.BaseModel
																							implements
																							java.io.Serializable {
	private java.lang.String account;
	
	private com.born.fcs.pm.integration.bpm.service.client.user.GrantedAuthorityValue[] authorities;
	...
	public SysUser(	java.lang.Long createBy,
					...
					com.born.fcs.pm.integration.bpm.service.client.user.GrantedAuthorityValue[] authorities,
	 ...
	 * @return authorities
	 */
	public com.born.fcs.pm.integration.bpm.service.client.user.GrantedAuthorityValue[] getAuthorities() {
		return authorities;
	}
	 ...
	 * @param authorities
	 */
	public void setAuthorities(	com.born.fcs.pm.integration.bpm.service.client.user.GrantedAuthorityValue[] authorities) {
		this.authorities = authorities;
	}
	
	public com.born.fcs.pm.integration.bpm.service.client.user.GrantedAuthorityValue getAuthorities(int i) {
		return this.authorities[i];
	}
	
	public void setAuthorities(	int i,
								com.born.fcs.pm.integration.bpm.service.client.user.GrantedAuthorityValue _value) {
