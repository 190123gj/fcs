...
public class FAfterwardsCheckBaseOrder extends ProjectFormOrderBase {
	...
	private List<FAfterwardsCreditConditionOrder> conditions; //授信落实条件
	...
	public List<FAfterwardsCreditConditionOrder> getConditions() {
		return this.conditions;
	}

	public void setConditions(List<FAfterwardsCreditConditionOrder> conditions) {
