package com.born.fcs.pm.ws.info.transfer;
 ...
 * @author wuzj
 */
public class ProjectTransferDetailInfo extends BaseToStringInfo {
	
	private static final long serialVersionUID = -654113647096351064L;
