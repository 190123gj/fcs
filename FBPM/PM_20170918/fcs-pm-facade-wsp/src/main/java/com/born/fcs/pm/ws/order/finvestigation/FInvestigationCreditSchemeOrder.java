 ...
 * 2016-3-8 下午3:38:50
 */
public class FInvestigationCreditSchemeOrder extends FInvestigationBaseOrder {
	...
	private List<ProjectChannelRelationOrder> capitalChannel; //资金渠道
//	private List<ProjectChannelRelationOrder> projectChannel; //项目渠道
	...
	public List<ProjectChannelRelationOrder> getProjectChannel() {
		List<ProjectChannelRelationOrder> list = new ArrayList<>();
		ProjectChannelRelationOrder order = new ProjectChannelRelationOrder();
		order.setChannelId(this.projectChannelId);
		order.setChannelCode(this.projectChannelCode);
		order.setChannelName(this.projectChannelName);
		order.setChannelType(this.projectChannelType);
		order.setSubChannelId(this.projectSubChannelId);
		order.setSubChannelCode(this.projectSubChannelCode);
		order.setSubChannelName(this.projectSubChannelName);
		order.setSubChannelType(this.projectSubChannelType);
		list.add(order);
		return list;
	}

//	public void setCapitalChannel(List<ProjectChannelRelationOrder> capitalChannel) {
//		this.capitalChannel = capitalChannel;
//	}
	
	
//	public List<ProjectChannelRelationOrder> getCapitalChannel() {
//		List<ProjectChannelRelationOrder> list = new ArrayList<>();
//		ProjectChannelRelationOrder order = new ProjectChannelRelationOrder();
//		order.setChannelId(this.capitalChannelId);
//		order.setChannelCode(this.capitalChannelCode);
//		order.setChannelName(this.capitalChannelName);
//		order.setChannelType(this.capitalChannelType);
//		order.setSubChannelId(this.capitalSubChannelId);
//		order.setSubChannelCode(this.capitalSubChannelCode);
//		order.setSubChannelName(this.capitalSubChannelName);
//		order.setSubChannelType(this.capitalSubChannelType);
//		list.add(order);
//		return list;
//	}
