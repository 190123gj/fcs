package com.born.fcs.pm.ws.service.sms;
...
public interface SMSService {
     ...
     * @param mobileNumber 手机号(多个电话用逗号“,“ 隔开)
     * @param smsContent 短信内容
     * @param isSend true 发短信 false 不发
     * @return
     */
    SMSInfo sendSMSWithSwitch(String mobileNumber, String smsContent,boolean isSend);
