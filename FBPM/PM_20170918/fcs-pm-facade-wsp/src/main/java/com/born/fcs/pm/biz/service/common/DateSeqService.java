...
public interface DateSeqService {
	 ...
	 * @return
	 */
	String getNextCouncilCodeSeqByParam(CompanyNameEnum company, CouncilTypeEnum councilType);
	
	/**
	 * 获取下一个可用的会议序列号
	 * @return
	 */
	String getAvailableCouncilCodeSeqByParam(CompanyNameEnum company, CouncilTypeEnum councilType);
	 ...
	 * @return
	 */
	String getNextAfterwardsCheckSeq(String projectCode);
