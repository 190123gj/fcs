...
public class CouncilOrder extends ProcessOrder {
	...
	/** 投票明细 */
	private String councilVoteMessage;
	...
	public String getCouncilVoteMessage() {
		return this.councilVoteMessage;
	}
	
	public void setCouncilVoteMessage(String councilVoteMessage) {
		this.councilVoteMessage = councilVoteMessage;
	}
	...
	public String getCouncilCodeOld() {
		return this.councilCodeOld;
	}
	
	public void setCouncilCodeOld(String councilCodeOld) {
		this.councilCodeOld = councilCodeOld;
	}
