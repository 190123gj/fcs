...
public class FormInfo extends BaseToStringInfo {
	...
	private Map<String, Object> customizeFieldMap = Maps.newHashMap();
	...
	public void setCustomizeField(String customizeField) {
		this.customizeField = customizeField;
	}
	
	@SuppressWarnings("unchecked")
	public Map<String, Object> getCustomizeFieldMap() {
		if (StringUtil.isNotBlank(customizeField)) {
			try {
				customizeFieldMap = (Map<String, Object>) JSONObject.parse(customizeField);
			} catch (Exception e) {
				logger.error("表单自定义字段转换出错 {}", e);
			}
		}
