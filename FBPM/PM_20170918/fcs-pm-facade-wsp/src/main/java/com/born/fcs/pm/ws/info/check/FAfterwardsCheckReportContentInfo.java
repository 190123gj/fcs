...
public class FAfterwardsCheckReportContentInfo extends BaseToStringInfo {
	...
	private List<FAfterwardsCheckReportCreditInfo> credits; //信用状况
	...
	private List<FAfterwardsNotCollectedDataInfo> notCollectes; //未收集数据说明
	private Map<String, String> notCollected; //未收集数据说明
	
	private BooleanEnum hasHistory = BooleanEnum.NO; //是否有历史版本
	...
	public List<FAfterwardsCheckReportCreditInfo> getCredits() {
		return this.credits;
	}

	public void setCredits(List<FAfterwardsCheckReportCreditInfo> credits) {
	...
	public List<FAfterwardsNotCollectedDataInfo> getNotCollectes() {
		return this.notCollectes;
	}

	public void setNotCollectes(List<FAfterwardsNotCollectedDataInfo> notCollectes) {
		this.notCollectes = notCollectes;
	}

	public Map<String, String> getNotCollected() {
		return this.notCollected;
	}

	public void setNotCollected(Map<String, String> notCollected) {
		this.notCollected = notCollected;
	}

	public BooleanEnum getHasHistory() {
		return this.hasHistory;
	}

	public void setHasHistory(BooleanEnum hasHistory) {
