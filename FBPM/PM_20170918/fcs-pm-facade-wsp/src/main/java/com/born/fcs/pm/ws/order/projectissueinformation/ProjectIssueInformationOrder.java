...
public class ProjectIssueInformationOrder extends FormOrderBase {
	 ...
	 * 发债类项目-分保信息
	 */
	private List<ProjectBondReinsuranceInformationOrder> listBondReinsuranceOrder;
	...
	public List<ProjectBondReinsuranceInformationOrder> getListBondReinsuranceOrder() {
		return listBondReinsuranceOrder;
	}
	
	public void setListBondReinsuranceOrder(List<ProjectBondReinsuranceInformationOrder> listBondReinsuranceOrder) {
		this.listBondReinsuranceOrder = listBondReinsuranceOrder;
	}
