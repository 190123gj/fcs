...
public class CreditRefrerenceApplyInfo extends BaseToStringInfo {
    ...
    private String customerApplyUrl;
    ...
    public String getCustomerApplyUrl() {
        return customerApplyUrl;
    }

    public void setCustomerApplyUrl(String customerApplyUrl) {
        this.customerApplyUrl = customerApplyUrl;
    }
