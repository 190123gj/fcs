 ...
 */
package com.born.fcs.pm.ws.enums.base;
...
public enum FcsResultEnum {
	 ...
	 * @param message
	 */
	private FcsResultEnum(String code, String message) {
		this.code = code;
	 ...
	 */
	public static FcsResultEnum getByCode(String code) {
		for (FcsResultEnum _enum : values()) {
	 ...
	 */
	public static List<FcsResultEnum> getAllEnum() {
		List<FcsResultEnum> list = new ArrayList<FcsResultEnum>();
		for (FcsResultEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
