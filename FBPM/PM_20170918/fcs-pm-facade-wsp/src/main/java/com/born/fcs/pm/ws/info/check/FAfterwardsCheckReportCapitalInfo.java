 ...
 * 2016-6-8 下午4:23:48
 */
public class FAfterwardsCheckReportCapitalInfo extends BaseToStringInfo{
	...
	private CapitalTypeEnum capitalType;
	...
	public CapitalTypeEnum getCapitalType() {
		return capitalType;
	}
	
	public void setCapitalType(CapitalTypeEnum capitalType) {
