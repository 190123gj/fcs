...
public class BaseAutowiredDAOService {
	...
	@Autowired
	protected FProjectFinancialReviewDAO FProjectFinancialReviewDAO;
	@Autowired
	protected FProjectFinancialContractDAO FProjectFinancialContractDAO;
	...
	@Autowired
	protected FCouncilSummaryProjectTextCreditConditionDAO fCouncilSummaryProjectTextCreditConditionDAO;
	...
	@Autowired
	protected FFinancialKpiDAO FFinancialKpiDAO;
	@Autowired
	...
	@Autowired
	protected FInvestigationCsRationalityReviewGuarantorDAO FInvestigationCsRationalityReviewGuarantorDAO;
	@Autowired
	...
	@Autowired
	protected FInvestigationCheckingDAO FInvestigationCheckingDAO;
	// 调查报告 end
	// 征信管理
	@Autowired
	...
	//发债类项目 分保信息
	@Autowired
	protected ProjectBondReinsuranceInformationDAO projectBondReinsuranceInformationDAO;
	// 项目授信条件 start
	@Autowired
	...
	@Autowired
	protected StampConfigureDAO stampConfigureDAO;
	@Autowired
	protected StampBasicDataDAO stampBasicDataDAO;
	@Autowired
	protected FStampBasicDataApplyDAO fStampBasicDataApplyDAO;
	@Autowired
	protected FStampBasicDataApplyFileDAO fStampBasicDataApplyFileDAO;
	@Autowired
	...
	@Autowired
	protected FProjectContractItemInvalidDAO fProjectContractItemInvalidDAO;
	...
	@Autowired
	protected FFileOutputExtensionDAO fileOutputExtensionDAO;
	...
	@Autowired
	protected FCounterGuaranteeRepayDAO FCounterGuaranteeRepayDAO;
	...
	@Autowired
	protected FCapitalAppropriationApplyTransferDAO FCapitalAppropriationApplyTransferDAO;
	@Autowired
	protected FCapitalAppropriationApplyFeeCompensatoryChannelDAO FCapitalAppropriationApplyFeeCompensatoryChannelDAO;
	...
	@Autowired
	protected FAfterwardsCheckReportCreditDAO FAfterwardsCheckReportCreditDAO;
	@Autowired
	...
	@Autowired
	protected FAfterwardsNotCollectedDataDAO FAfterwardsNotCollectedDataDAO;
	@Autowired
	protected FAfterwardsCustomerDAO FAfterwardsCustomerDAO;
	...
	@Autowired
	protected ProjectRecoveryOtherDAO projectRecoveryOtherDAO;
	@Autowired
	...
	@Autowired
	protected SysDataDictionaryDAO sysDataDictionaryDAO;
	@Autowired
	protected ProjectVirtualDAO projectVirtualDAO;
	@Autowired
	protected ProjectVirtualDetailDAO projectVirtualDetailDAO;
	...
	@Autowired
	protected ProjectDataInfoDAO projectDataInfoDAO;
	
	@Autowired
	protected ProjectDataInfoHisDataDAO projectDataInfoHisDataDAO;
	
	//报表 end
	
	//财务确认 start
	@Autowired
	protected FFinanceAffirmDAO fFinanceAffirmDAO;
	@Autowired
	protected FFinanceAffirmDetailDAO fFinanceAffirmDetailDAO;
	@Autowired
	protected ChargeNoticeCapitalApproproationDAO chargeNoticeCapitalApproproationDAO;
	//财务确认 end
	
	//项目渠道关系表
	@Autowired
	protected ProjectChannelRelationDAO projectChannelRelationDAO;
	
	//渠道报表
	@Autowired
	protected ViewChannelReportHiDAO viewChannelReportHiDAO;
	@Autowired
	protected ViewChannelReportDAO viewChannelReportDAO;
	//短信发送
	@Autowired
	protected ShortMessageDAO shortMessageDAO;
	
	@Autowired
	protected ProjectTransferDetailDAO projectTransferDetailDAO;
