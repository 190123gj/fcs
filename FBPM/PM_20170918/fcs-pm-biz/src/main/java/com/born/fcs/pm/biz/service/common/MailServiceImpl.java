...
import com.born.fcs.pm.ws.order.common.SendMailAttachOrder;
...
public class MailServiceImpl extends BaseAutowiredDomainService implements MailService {
	...
	@Override
	public FcsBaseResult sendTextEmail(SendMailOrder order) {
	...
	@Override
	public FcsBaseResult sendHtmlEmail(SendMailOrder order) {
