...
public interface ProjectFinancialTradeTansferDAO {
	 ...
	 *  <tt>insert into project_financial_trade_tansfer(trade_id,flow_no,project_code,apply_id,transfer_price,transfer_num,transfer_interest,transfer_time,transfer_to,interest_rate,is_transfer_ownership,is_buy_back,buy_back_price,buy_back_time,is_confirm,confirm_time,transfer_reason,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update project_financial_trade_tansfer set flow_no=?, project_code=?, apply_id=?, transfer_price=?, transfer_num=?, transfer_interest=?, transfer_time=?, transfer_to=?, interest_rate=?, is_transfer_ownership=?, is_buy_back=?, buy_back_price=?, buy_back_time=?, is_confirm=?, confirm_time=?, transfer_reason=? where (trade_id = ?)</tt>
	 *
	 *	@param projectFinancialTradeTansfer
	 *	@return int
	 *	@throws DataAccessException
