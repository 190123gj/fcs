...
public class IbatisFCouncilSummaryDAO extends SqlMapClientDaoSupport implements FCouncilSummaryDAO {
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select * from f_council_summary where (summary_code = ?)</tt>
	 *
	 *	@param summaryCode
	 *	@return FCouncilSummaryDO
	 *	@throws DataAccessException
	 */	 
    public FCouncilSummaryDO findBySummaryCode(String summaryCode) throws DataAccessException {

        return (FCouncilSummaryDO) getSqlMapClientTemplate().queryForObject("MS-F-COUNCIL-SUMMARY-FIND-BY-SUMMARY-CODE", summaryCode);
