...
/**
 * A dao interface provides methods to access database table <tt>project_recovery_litigation_referee</tt>.
 *
...
public interface ProjectRecoveryLitigationRefereeDAO {
	/**
