...
public interface ChargeRepayPlanDAO {
	 ...
	 *  <tt>insert into charge_repay_plan(plan_id,project_code,project_name,customer_id,customer_name,busi_type,busi_type_name,is_charge_plan,is_repay_plan,user_id,user_account,user_name,dept_id,dept_code,dept_name,dept_path,dept_path_name,remark,is_affirm,before_days,cycle_days,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update charge_repay_plan set project_code=?, project_name=?, customer_id=?, customer_name=?, busi_type=?, busi_type_name=?, is_charge_plan=?, is_repay_plan=?, user_id=?, user_account=?, user_name=?, dept_id=?, dept_code=?, dept_name=?, dept_path=?, dept_path_name=?, remark=?, is_affirm=?, before_days=?, cycle_days=? where (plan_id = ?)</tt>
	 *
	 *	@param chargeRepayPlan
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *	@throws DataAccessException
	 */	 
    public List<ChargeRepayPlanDO> findByCondition(ChargeRepayPlanDO chargeRepayPlan, long loginUserId, long draftUserId, List deptIdList, String sortCol, String sortOrder, long limitStart, long pageSize) throws DataAccessException;
	 ...
	 *	@throws DataAccessException
	 */	 
    public long findByConditionCount(ChargeRepayPlanDO chargeRepayPlan, long loginUserId, long draftUserId, List deptIdList) throws DataAccessException;
