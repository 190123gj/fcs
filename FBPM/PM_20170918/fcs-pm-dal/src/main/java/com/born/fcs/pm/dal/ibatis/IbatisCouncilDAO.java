...
public class IbatisCouncilDAO extends SqlMapClientDaoSupport implements CouncilDAO {
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select * from council where (council_code = ?)</tt>
	 *
	 *	@param councilCode
	 *	@return List<CouncilDO>
	 *	@throws DataAccessException
	 */	 
    public List<CouncilDO> findByCode(String councilCode) throws DataAccessException {

        return getSqlMapClientTemplate().queryForList("MS-COUNCIL-FIND-BY-CODE", councilCode);
	 ...
	 *	@throws DataAccessException
	 */	 
    public List<CouncilDO> findByCondition(CouncilDO council, long limitStart, long pageSize, Date startTimeBegin, Date startTimeEnd, List councilTypeCodeList, List companyNames, List statusList, String projectName) throws DataAccessException {
    	if (council == null) {
	 ...
	 *	@throws DataAccessException
	 */	 
    public long findByConditionCount(CouncilDO council, Date startTimeBegin, Date startTimeEnd, List councilTypeCodeList, List companyNames, List statusList, String projectName) throws DataAccessException {
    	if (council == null) {
    		throw new IllegalArgumentException("Can't select by a null data object.");
    	}
	 ...
	 *	@throws DataAccessException
	 */	 
    public List<CouncilDO> findByConditionWithRelatveId(CouncilDO council, long relatveId, long limitStart, long pageSize, Date startTimeBegin, Date startTimeEnd, List companyNames, List statusList, String projectName) throws DataAccessException {
    	if (council == null) {
    		throw new IllegalArgumentException("Can't select by a null data object.");
    	}
	 ...
	 *	@throws DataAccessException
	 */	 
    public long findByConditionWithRelatveIdCount(CouncilDO council, long relatveId, Date startTimeBegin, Date startTimeEnd, List companyNames, List statusList, String projectName) throws DataAccessException {
    	if (council == null) {
    		throw new IllegalArgumentException("Can't select by a null data object.");
    	}
