...
public class IbatisProjectRecoveryLitigationBeforePreservationPrecautionDAO extends SqlMapClientDaoSupport implements ProjectRecoveryLitigationBeforePreservationPrecautionDAO {
    ...
    public List<ProjectRecoveryLitigationBeforePreservationPrecautionDO> findByLitigationBeforePreservationIdAndType(long projectRecoveryLitigationBeforePreservationId, String projectRecoveryLitigationType) throws DataAccessException {
        ...
        param.put("projectRecoveryLitigationBeforePreservationId", new Long(projectRecoveryLitigationBeforePreservationId));
        param.put("projectRecoveryLitigationType", projectRecoveryLitigationType);

        return getSqlMapClientTemplate().queryForList("MS-PROJECT-RECOVERY-LITIGATION-BEFORE-PRESERVATION-PRECAUTION-FIND-BY-LITIGATION-BEFORE-PRESERVATION-ID-AND-TYPE", param);
    ...
    public List<ProjectRecoveryLitigationBeforePreservationPrecautionDO> findByLitigationPreservationIdAndType(long projectRecoveryLitigationPreservationId, String projectRecoveryLitigationType) throws DataAccessException {
        ...
        param.put("projectRecoveryLitigationPreservationId", new Long(projectRecoveryLitigationPreservationId));
        param.put("projectRecoveryLitigationType", projectRecoveryLitigationType);

        return getSqlMapClientTemplate().queryForList("MS-PROJECT-RECOVERY-LITIGATION-BEFORE-PRESERVATION-PRECAUTION-FIND-BY-LITIGATION-PRESERVATION-ID-AND-TYPE", param);
    ...
    public int deleteByLitigationBeforePreservationIdAndType(long projectRecoveryLitigationBeforePreservationId, String projectRecoveryLitigationType) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-PROJECT-RECOVERY-LITIGATION-BEFORE-PRESERVATION-PRECAUTION-DELETE-BY-LITIGATION-BEFORE-PRESERVATION-ID-AND-TYPE", param);
    }
    ...
    public int deleteByLitigationPreservationIdAndType(long projectRecoveryLitigationPreservationId, String projectRecoveryLitigationType) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-PROJECT-RECOVERY-LITIGATION-BEFORE-PRESERVATION-PRECAUTION-DELETE-BY-LITIGATION-PRESERVATION-ID-AND-TYPE", param);
    }
