...
public class IbatisFLoanUseApplyReceiptDAO extends SqlMapClientDaoSupport implements FLoanUseApplyReceiptDAO {
    ...
    public List<FLoanUseApplyReceiptDO> findByApplyId(long applyId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-LOAN-USE-APPLY-RECEIPT-FIND-BY-APPLY-ID", param);
    ...
    public List<FLoanUseApplyReceiptDO> findAll() throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-LOAN-USE-APPLY-RECEIPT-FIND-ALL", null);
