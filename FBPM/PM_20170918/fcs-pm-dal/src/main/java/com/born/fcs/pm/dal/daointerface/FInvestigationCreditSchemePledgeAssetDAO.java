...
/**
 * A dao interface provides methods to access database table <tt>f_investigation_credit_scheme_pledge_asset</tt>.
 *
...
public interface FInvestigationCreditSchemePledgeAssetDAO {
	/**
