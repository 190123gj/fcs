...
public class IbatisFCreditConditionConfirmItemDAO extends SqlMapClientDaoSupport implements FCreditConditionConfirmItemDAO {
    ...
    public int deleteByConfirmId(long confirmId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-CREDIT-CONDITION-CONFIRM-ITEM-DELETE-BY-CONFIRM-ID", param);
    }
    ...
    public List<FCreditConditionConfirmItemDO> findByProjectCodeAndItemIdAndType(String projectCode, long itemId, String type) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-CREDIT-CONDITION-CONFIRM-ITEM-FIND-BY-PROJECT-CODE-AND-ITEM-ID-AND-TYPE", param);
