...
public class MoneyUtil {
	 ...
	 * @return
	 */
	public static String getMoneyByq2(Money amount) {
		if (amount == null)
			return "0";
		double d = amount.getCent() / 100000.00d;
	 ...
	 * @return
	 */
	public static String toWStandardString(Money amount) {
		if (amount == null)
			return "0";
		return amount.divide(10000).toStandardString();
	}
	 ...
	 * @return
	 */
	public static String toYStandardString(Money amount) {
		if (amount == null)
			return "0";
		return amount.divide(100000000).toStandardString();
	}
	...
	public static Money getMoneyStre(String str) {
		if (StringUtil.isBlank(str)) {
			return new Money(0L);
		}
		return Money.amout(str);
