...
public class SpecialPaperResultDO implements Serializable {

    private static final long serialVersionUID = 6633866102730038611L;
    private long id;
    ...
    private String isSaveInvail;

    public String getIsSaveInvail() {
        return isSaveInvail;
    }

    public void setIsSaveInvail(String isSaveInvail) {
        this.isSaveInvail = isSaveInvail;
    }
