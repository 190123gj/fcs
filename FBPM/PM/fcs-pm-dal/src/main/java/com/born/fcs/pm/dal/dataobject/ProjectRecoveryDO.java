...
public class ProjectRecoveryDO implements Serializable{
	...
	public String getOtherOn() {
		return otherOn;
	}
	
	public void setOtherOn(String otherOn) {
