...
public class IbatisExtraDAO extends SqlMapClientDaoSupport implements ExtraDAO {
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public List<SetupFormProjectDO> searchSetupForm(SetupFormProjectDO setupForm, long limitStart,
		...
		paramMap.put("trueCustomerId", setupForm.getTrueCustomerId());
		...
		List<SetupFormProjectDO> list = getSqlMapClientTemplate().queryForList(
	...
	@Override
	public long findCreditRefrerenceApplyInfosCount(CreditRefrerenceApplyFormDO creditRefrerenceApplyFromDO) {
		if (creditRefrerenceApplyFromDO == null) {
			throw new IllegalArgumentException("creditRefrerenceApplyFromDO can`t by null");
		}
		...
		return (Long) getSqlMapClientTemplate().queryForObject(
			"MS-CREDIT-REFRERENCE-LIST-SEARCH-COUNT", paramMap);
	}

	@Override
	public List<CreditRefrerenceApplyFormDO> findCreditRefrerenceApplyInfos(CreditRefrerenceApplyFormDO creditRefrerenceApplyFromDO,
			long limitStart, long pageSize, String sortCol, String sortOrder) {
			if (creditRefrerenceApplyFromDO == null) {
			throw new IllegalArgumentException("creditRefrerenceApplyFromDO can`t by null");
			}
			...
			List<CreditRefrerenceApplyFormDO> list = getSqlMapClientTemplate().queryForList(
			"RM-CREDIT-REFRERENCE-LIST-SEARCH", paramMap);
		return list;
	}

	@Override
	public List<CreditRefrerenceApplyFormDO> searchNewCreditApplyList(CreditRefrerenceApplyFormDO creditRefrerenceApplyFromDO) {
		if (creditRefrerenceApplyFromDO == null) {
			throw new IllegalArgumentException("creditRefrerenceApplyFromDO can`t by null");
		}
		...
		List<CreditRefrerenceApplyFormDO> list = getSqlMapClientTemplate().queryForList(
			"RM-NEW-CREDIT-REFRERENCE-APPLY-PROJECT-SEARCH", paramMap);
		return list;
	}
