...
public class IbatisFFileDAO extends SqlMapClientDaoSupport implements FFileDAO {
	 ...
	 *  <tt>insert into f_file(form_id,file_code,old_file_code,type,project_code,project_name,customer_id,customer_name,busi_manager_id,busi_manager_name,first_loan_time,filing_time,hand_over_dept_code,hand_over_dept,hand_over_man_id,hand_over_man,hand_over_time,principal_man,vice_manager,receive_dept_code,receive_dept,receive_man_id,receive_man,receive_time,status,file_check_status,dept_code,dept_name,update_time,remark,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 *	@param FFile
	 *	@return long
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_file set form_id=?, file_code=?, old_file_code=?, type=?, project_code=?, project_name=?, customer_id=?, customer_name=?, busi_manager_id=?, busi_manager_name=?, first_loan_time=?, filing_time=?, hand_over_dept_code=?, hand_over_dept=?, hand_over_man_id=?, hand_over_man=?, hand_over_time=?, principal_man=?, vice_manager=?, receive_dept_code=?, receive_dept=?, receive_man_id=?, receive_man=?, receive_time=?, status=?, file_check_status=?, update_time=?, remark=? where (file_id = ?)</tt>
	 *
	 *	@param FFile
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_file set file_code=?, old_file_code=?, type=?, project_code=?, project_name=?, customer_id=?, customer_name=?, busi_manager_id=?, busi_manager_name=?, first_loan_time=?, filing_time=?, hand_over_dept_code=?, hand_over_dept=?, hand_over_man_id=?, hand_over_man=?, hand_over_time=?, principal_man=?, vice_manager=?, receive_dept_code=?, receive_dept=?, receive_man_id=?, receive_man=?, receive_time=?, status=?, file_check_status=?, update_time=?, remark=? where (form_id = ?)</tt>
	 *
	 *	@param FFile
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *	@throws DataAccessException
	 */	 
    public List<FFileDO> findByCondition(FFileDO FFile, long limitStart, long pageSize, List ids) throws DataAccessException {
    	if (FFile == null) {
	 ...
	 *	@throws DataAccessException
	 */	 
    public long findByConditionCount(FFileDO FFile, List ids) throws DataAccessException {
    	if (FFile == null) {
    		throw new IllegalArgumentException("Can't select by a null data object.");
    	}
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-F-FILE-FIND-BY-CONDITION-COUNT", param);
