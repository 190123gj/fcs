...
public class IbatisFInvestigationFinancialReviewDAO extends SqlMapClientDaoSupport implements FInvestigationFinancialReviewDAO {
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select * from f_investigation_financial_review where (form_id = ?) order by sub_index ASC</tt>
	 *
	 *	@param formId
	 *	@return List<FInvestigationFinancialReviewDO>
	 *	@throws DataAccessException
	 */	 
    public List<FInvestigationFinancialReviewDO> findByFormId(long formId) throws DataAccessException {
        Long param = new Long(formId);

        return getSqlMapClientTemplate().queryForList("MS-F-INVESTIGATION-FINANCIAL-REVIEW-FIND-BY-FORM-ID", param);
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select * from f_investigation_financial_review where ((form_id = ?) AND (sub_index = ?))</tt>
	 *
	 *	@param formId
	 *	@param subIndex
	 *	@return FInvestigationFinancialReviewDO
	 *	@throws DataAccessException
	 */	 
    public FInvestigationFinancialReviewDO findByFormIdAndSubindex(long formId, int subIndex) throws DataAccessException {
        Map param = new HashMap();

        param.put("formId", new Long(formId));
        param.put("subIndex", new Integer(subIndex));

        return (FInvestigationFinancialReviewDO) getSqlMapClientTemplate().queryForObject("MS-F-INVESTIGATION-FINANCIAL-REVIEW-FIND-BY-FORM-ID-AND-SUBINDEX", param);
