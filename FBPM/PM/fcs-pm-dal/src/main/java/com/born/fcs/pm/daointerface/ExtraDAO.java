...
public interface ExtraDAO {
	 ...
	 * @throws DataAccessException
	 */
	List<SetupFormProjectDO> searchSetupForm(SetupFormProjectDO setupForm, long limitStart,
	 ...
	 * @throws DataAccessException
	 */
	List<FileExtensionFormDO> searchExtensionList(FileFormDO fileFormDO, long limitStart,
													long pageSize, String sortCol, String sortOrder)
																									throws DataAccessException;
	 ...
	 * @return
	 */
	public long findCreditRefrerenceApplyInfosCount(CreditRefrerenceApplyFormDO queryCondition);
	 ...
	 * @return
	 */
	public List<CreditRefrerenceApplyFormDO> findCreditRefrerenceApplyInfos(CreditRefrerenceApplyFormDO queryCondition,
			long firstRecord, long pageSize, String sortCol, String sortOrder);
	 ...
	 * @return
	 */
	public List<CreditRefrerenceApplyFormDO> searchNewCreditApplyList(CreditRefrerenceApplyFormDO queryCondition);
}
