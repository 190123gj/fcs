...
public interface FInvestigationMabilityReviewLeadingTeamDAO {
	 ...
	 *  <tt>insert into f_investigation_mability_review_leading_team(ma_review_id,owner,name,sex,birth,age,degree,title,resume,sort_order,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_investigation_mability_review_leading_team set ma_review_id=?, owner=?, name=?, sex=?, birth=?, age=?, degree=?, title=?, resume=?, sort_order=? where (id = ?)</tt>
	 *
	 *	@param FInvestigationMabilityReviewLeadingTeam
	 *	@return int
	 *	@throws DataAccessException
