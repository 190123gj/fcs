...
import com.born.fcs.pm.dal.daointerface.FInvestigationMainlyReviewAssetAndLiabilityDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.FInvestigationMainlyReviewAssetAndLiabilityDAO</tt>.
 *
...
public class IbatisFInvestigationMainlyReviewAssetAndLiabilityDAO extends SqlMapClientDaoSupport implements FInvestigationMainlyReviewAssetAndLiabilityDAO {
	/**
    ...
    public long insert(FInvestigationMainlyReviewAssetAndLiabilityDO FInvestigationMainlyReviewAssetAndLiability) throws DataAccessException {
    	if (FInvestigationMainlyReviewAssetAndLiability == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-F-INVESTIGATION-MAINLY-REVIEW-ASSET-AND-LIABILITY-INSERT", FInvestigationMainlyReviewAssetAndLiability);

        return FInvestigationMainlyReviewAssetAndLiability.getId();
    }
    ...
    public int update(FInvestigationMainlyReviewAssetAndLiabilityDO FInvestigationMainlyReviewAssetAndLiability) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-F-INVESTIGATION-MAINLY-REVIEW-ASSET-AND-LIABILITY-UPDATE", FInvestigationMainlyReviewAssetAndLiability);
    }
    ...
    public FInvestigationMainlyReviewAssetAndLiabilityDO findById(long id) throws DataAccessException {
        ...
        return (FInvestigationMainlyReviewAssetAndLiabilityDO) getSqlMapClientTemplate().queryForObject("MS-F-INVESTIGATION-MAINLY-REVIEW-ASSET-AND-LIABILITY-FIND-BY-ID", param);
    ...
    public List<FInvestigationMainlyReviewAssetAndLiabilityDO> findByReviewId(long MReviewId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-INVESTIGATION-MAINLY-REVIEW-ASSET-AND-LIABILITY-FIND-BY-REVIEW-ID", param);
    ...
    public int deleteById(long id) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-INVESTIGATION-MAINLY-REVIEW-ASSET-AND-LIABILITY-DELETE-BY-ID", param);
    }
    ...
    public int deleteByReviewId(long MReviewId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-INVESTIGATION-MAINLY-REVIEW-ASSET-AND-LIABILITY-DELETE-BY-REVIEW-ID", param);
    }
