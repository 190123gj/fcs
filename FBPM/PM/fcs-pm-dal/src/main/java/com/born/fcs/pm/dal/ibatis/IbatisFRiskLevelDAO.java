...
public class IbatisFRiskLevelDAO extends SqlMapClientDaoSupport implements FRiskLevelDAO {
	 ...
	 *  <tt>insert into f_risk_level(form_id,project_code,project_name,customer_id,customer_name,busi_type,busi_type_name,credit_amount,check_phase,evaluation,evaluation_level,has_evaluation_desc,evaluation_desc,reevaluation_id,reevaluation_account,reevaluation_name,reevaluation,reevaluation_level,has_reevaluation_desc,reevaluation_desc,enterprise_type,project_type,check_level1,check_level2,check_level3,check_level,raw_add_time) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)</tt>
	 *
	 *	@param FRiskLevel
	 *	@return long
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_risk_level set form_id=?, project_code=?, project_name=?, customer_id=?, customer_name=?, busi_type=?, busi_type_name=?, credit_amount=?, check_phase=?, evaluation=?, evaluation_level=?, has_evaluation_desc=?, evaluation_desc=?, reevaluation_id=?, reevaluation_account=?, reevaluation_name=?, reevaluation=?, reevaluation_level=?, has_reevaluation_desc=?, reevaluation_desc=?, enterprise_type=?, project_type=?, check_level1=?, check_level2=?, check_level3=?, check_level=? where (id = ?)</tt>
	 *
	 *	@param FRiskLevel
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_risk_level set project_code=?, project_name=?, customer_id=?, customer_name=?, busi_type=?, busi_type_name=?, credit_amount=?, check_phase=?, evaluation=?, evaluation_level=?, has_evaluation_desc=?, evaluation_desc=?, reevaluation_id=?, reevaluation_account=?, reevaluation_name=?, reevaluation=?, reevaluation_level=?, has_reevaluation_desc=?, reevaluation_desc=?, enterprise_type=?, project_type=?, check_level1=?, check_level2=?, check_level3=?, check_level=? where (form_id = ?)</tt>
	 *
	 *	@param FRiskLevel
	 *	@return int
	 *	@throws DataAccessException
