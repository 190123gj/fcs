...
import com.born.fcs.pm.dal.daointerface.RecoverProjectTrackRecordDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.RecoverProjectTrackRecordDAO</tt>.
 *
...
public class IbatisRecoverProjectTrackRecordDAO extends SqlMapClientDaoSupport implements RecoverProjectTrackRecordDAO {
	/**
    ...
    public long insert(RecoverProjectTrackRecordDO recoverProjectTrackRecord) throws DataAccessException {
    	if (recoverProjectTrackRecord == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-RECOVER-PROJECT-TRACK-RECORD-INSERT", recoverProjectTrackRecord);

        return recoverProjectTrackRecord.getId();
    }
    ...
    public int update(RecoverProjectTrackRecordDO recoverProjectTrackRecord) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-RECOVER-PROJECT-TRACK-RECORD-UPDATE", recoverProjectTrackRecord);
    }
    ...
    public RecoverProjectTrackRecordDO findById(long id) throws DataAccessException {
        ...
        return (RecoverProjectTrackRecordDO) getSqlMapClientTemplate().queryForObject("MS-RECOVER-PROJECT-TRACK-RECORD-FIND-BY-ID", param);
    ...
    public List<RecoverProjectTrackRecordDO> findByRecoverId(long recoverId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-RECOVER-PROJECT-TRACK-RECORD-FIND-BY-RECOVER-ID", param);
    ...
    public int deleteById(long id) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-RECOVER-PROJECT-TRACK-RECORD-DELETE-BY-ID", param);
    }
    ...
    public int deleteByRecoverId(long recoverId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-RECOVER-PROJECT-TRACK-RECORD-DELETE-BY-RECOVER-ID", param);
    }
