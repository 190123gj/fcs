...
import com.born.fcs.pm.dal.daointerface.FInvestigationCsRationalityReviewGuarantorDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.FInvestigationCsRationalityReviewGuarantorDAO</tt>.
 *
...
public class IbatisFInvestigationCsRationalityReviewGuarantorDAO extends SqlMapClientDaoSupport implements FInvestigationCsRationalityReviewGuarantorDAO {
	/**
    ...
    public long insert(FInvestigationCsRationalityReviewGuarantorDO FInvestigationCsRationalityReviewGuarantor) throws DataAccessException {
    	if (FInvestigationCsRationalityReviewGuarantor == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-INSERT", FInvestigationCsRationalityReviewGuarantor);

        return FInvestigationCsRationalityReviewGuarantor.getGuarantorId();
    }
    ...
    public int update(FInvestigationCsRationalityReviewGuarantorDO FInvestigationCsRationalityReviewGuarantor) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-UPDATE", FInvestigationCsRationalityReviewGuarantor);
    }
    ...
    public FInvestigationCsRationalityReviewGuarantorDO findById(long guarantorId) throws DataAccessException {
        Long param = new Long(guarantorId);

        return (FInvestigationCsRationalityReviewGuarantorDO) getSqlMapClientTemplate().queryForObject("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-FIND-BY-ID", param);
    ...
    public List<FInvestigationCsRationalityReviewGuarantorDO> findByFormId(long formId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-FIND-BY-FORM-ID", param);
    ...
    public List<FInvestigationCsRationalityReviewGuarantorDO> findByFormIdAndType(long formId, String guarantorType) throws DataAccessException {
        ...
        param.put("guarantorType", guarantorType);

        return getSqlMapClientTemplate().queryForList("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-FIND-BY-FORM-ID-AND-TYPE", param);
    ...
    public int deleteById(long guarantorId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-DELETE-BY-ID", param);
    }
    ...
    public int deleteByFormId(long formId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-DELETE-BY-FORM-ID", param);
    }
    ...
    public int deleteByFormIdAndType(long formId, String guarantorType) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-INVESTIGATION-CS-RATIONALITY-REVIEW-GUARANTOR-DELETE-BY-FORM-ID-AND-TYPE", param);
    }
