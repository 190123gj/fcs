...
import com.born.fcs.pm.dal.daointerface.FAfterwardsCheckBaseDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.pm.dal.daointerface.FAfterwardsCheckBaseDAO</tt>.
 *
...
public class IbatisFAfterwardsCheckBaseDAO extends SqlMapClientDaoSupport implements FAfterwardsCheckBaseDAO {
    ...
    public long insert(FAfterwardsCheckBaseDO FAfterwardsCheckBase) throws DataAccessException {
    	if (FAfterwardsCheckBase == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-F-AFTERWARDS-CHECK-BASE-INSERT", FAfterwardsCheckBase);

        return FAfterwardsCheckBase.getBaseId();
    }
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update f_afterwards_check_base set form_id=?, project_name=?, project_code=?, customer_id=?, customer_name=?, busi_type=?, busi_type_name=?, amount=?, start_time=?, end_time=?, busi_manager_name=?, risk_manager_name=?, capital_channel_name=?, loan_purpose=?, spend_way=?, time_limit=?, time_unit=?, loaned_amount=?, repayed_amount=?, available_amount=?, release_balance=?, guarantee_amount=?, guarantee_deposit=?, collect_year=?, collect_month=?, collect_data=?, feedback_opinion=?, customer_opinion=?, remark1=?, remark2=? where (base_id = ?)</tt>
	 *
	 *	@param FAfterwardsCheckBase
	 *	@return int
	 *	@throws DataAccessException
    ...
    public int update(FAfterwardsCheckBaseDO FAfterwardsCheckBase) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-F-AFTERWARDS-CHECK-BASE-UPDATE", FAfterwardsCheckBase);
    }
    ...
    public FAfterwardsCheckBaseDO findById(long baseId) throws DataAccessException {
        ...
        return (FAfterwardsCheckBaseDO) getSqlMapClientTemplate().queryForObject("MS-F-AFTERWARDS-CHECK-BASE-FIND-BY-ID", param);
    ...
    public FAfterwardsCheckBaseDO findByFormId(long formId) throws DataAccessException {
        ...
        return (FAfterwardsCheckBaseDO) getSqlMapClientTemplate().queryForObject("MS-F-AFTERWARDS-CHECK-BASE-FIND-BY-FORM-ID", param);
    ...
    public int deleteById(long baseId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-AFTERWARDS-CHECK-BASE-DELETE-BY-ID", param);
    }
    ...
    public int deleteByFormId(long formId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-F-AFTERWARDS-CHECK-BASE-DELETE-BY-FORM-ID", param);
    }
