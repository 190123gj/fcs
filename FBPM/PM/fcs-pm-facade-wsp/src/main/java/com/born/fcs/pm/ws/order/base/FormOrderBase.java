...
public class FormOrderBase extends ProcessOrder {
	...
	/** 自定义字段 */
	protected Map<String, Object> customizeFieldMap = Maps.newHashMap();
	
	/** 自定义字段旧数据保存 */
	protected Map<String, Object> copyCustomizeFieldMap = Maps.newHashMap();
	...
	public Map<String, Object> getCustomizeFieldMap() {
		return this.customizeFieldMap;
	}
	
	public void setCustomizeFieldMap(Map<String, Object> customizeFieldMap) {
		this.customizeFieldMap = customizeFieldMap;
	}
	
	
	public Map<String, Object> getCopyCustomizeFieldMap() {
		return copyCustomizeFieldMap;
	}

	public void setCopyCustomizeFieldMap(Map<String, Object> copyCustomizeFieldMap) {
		this.copyCustomizeFieldMap = copyCustomizeFieldMap;
	}
