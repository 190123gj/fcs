...
public interface InvestigationService {
	...
	/**
	 * 根据表单id,子页面索引查找 客户财务评价
	 * @param formId formId 表单id
	 * @param subIndex 子页面索引
	 * @return 没有数据返回null
	 */
	FInvestigationFinancialReviewInfo findFInvestigationFinancialReviewByFormIdAndSubindex(long formId, int subIndex);
	...
	/**
	 * 根据资产Id 查询该资产是否被尽职调查使用
	 * @param assetsId
	 * @return
	 */
	long investigationUseAssetCount(long assetsId);
	 ...
	 * @return
	 */
	FcsBaseResult updateCustomerInfo(UpdateInvestigationCustomerOrder order);
	 ...
	 * @return
	 */
	FcsBaseResult createChecking(InvestigationCheckingOrder order);
	 ...
	 * @return
	 */
	InvestigationCheckingInfo findCheckingByFormId(long formId);
	 ...
	 * @return
	 */
	InvestigationCheckingInfo findCheckingByCheckPiontAndRelatedFormId(String checkPoint, long relatedFormId);
	 ...
	 * @return
	 */
	List<InvestigationCheckingInfo> findCheckingByRelatedFormId(long relatedFormId);
	
	/**
	 * 删除附件
	 * @param formId
	 */
	void deleteInvestigationCommonAttachment(long formId);
}
