 ...
 */
public class FInvestigationFinancialReviewInfo extends InvestigationBaseInfo {
	...
	public BooleanEnum getIsActive() {
		return isActive;
	}

	public void setIsActive(BooleanEnum isActive) {
