...
public enum SysDateSeqNameEnum {
	...
	/** 总部项目评审会 **/
	COUNCIL_CODE_SEQ_JCK_PS("COUNCIL_CODE_SEQ_JCK_PS", "会议编号"),
	
	/** 总部总经理办公会 **/
	COUNCIL_CODE_SEQ_JCK_ZJ("COUNCIL_CODE_SEQ_JCK_ZJ", "会议编号"),
	
	/** 总部风险处置会 **/
	COUNCIL_CODE_SEQ_JCK_FX("COUNCIL_CODE_SEQ_JCK_FX", "会议编号"),
	
	/** 信惠项目评审会 **/
	COUNCIL_CODE_SEQ_XH_PS("COUNCIL_CODE_SEQ_XH_PS", "会议编号"),
	
	/** 信惠总经理办公会 **/
	COUNCIL_CODE_SEQ_XH_ZJ("COUNCIL_CODE_SEQ_XH_ZJ", "会议编号"),
	...
	COUNCIL_RH_CODE_SEQ("COUNCIL_RH_CODE_SEQ", "会议纪要风险处置编号"),
	
	STAMP_APPLY_CODE_SEQ("STAMP_APPLY_CODE_SEQ", "用印申请单编号"),
	
	STAMP_BASIC_APPLY_CODE_SEQ("STAMP_BASIC_APPLY_CODE_SEQ", "基础资料用印申请单编号"),
	
	PROJECT_CONTRACT_CODE_SEQ("PROJECT_CONTRACT_CODE_SEQ", "合同编号"),
	
	PROJECT_WRIT_CODE_SEQ("PROJECT_WRIT_CODE_SEQ", "文书编号"),
	
	PROJECT_DB_LETTER_CODE_SEQ("PROJECT_DB_LETTER_CODE_SEQ", "担保函出具/保证合同签订"),
