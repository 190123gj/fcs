...
public interface ProjectRelatedUserService {
	...
	/**
	 * 根据部门编号和职位编码获取指定部门指定角色的人员
	 * @param deptCode
	 * @param roleName
	 * @return
	 */
	List<SimpleUserInfo> getDeptPosUser(String deptCode, String posName);
	
	/**
	 * 根据部门ID和职位编码获取指定部门指定角色的人员
	 * @param deptCode
	 * @param roleName
	 * @return
	 */
	List<SimpleUserInfo> getPosDeptUser(long deptId, String posName);
