...
public enum FormCodeEnum {
	...
	SET_UP_INNOVATIVE_PRODUCT("SET_UP_INNOVATIVE_PRODUCT", "ProjectApproval",
								"projectSetupProcessService", "/projectMg/setUp/view.htm",
								"/projectMg/setUp/edit.htm", "/projectMg/setUp/print.htm", "0",
								"创新业务产品项目立项"),
	...
	INVESTIGATION_INNOVATIVE_PRODUCT("INVESTIGATION_INNOVATIVE_PRODUCT", "ProjectInspect",
										"investigationProcessService",
										"/projectMg/investigation/view.htm",
										"/projectMg/investigation/editDeclare.htm", "", "10",
										"创新业务产品尽职调查报告"),
	...
	TRAVEL_EXPENSE_APPLY("TRAVEL_EXPENSE_APPLY", "TravelExpenseReimbursing",
							...
							"/fundMg/travelExpense/edit.htm", "/fundMg/travelExpense/print.htm",
							"0", "差旅费报销单"),
	...
	EXPENSE_APPLICATION_UNION_FUNDS("EXPENSE_APPLICATION_UNION_FUNDS",
									"UnionFundsPaymentBillsAudit", "expenseApplyProcessService",
									"/fundMg/expenseApplication/view.htm",
									"/fundMg/expenseApplication/edit.htm",
