 ...
 */
package com.born.fcs.pm.ws.info.user;
...
public class UserExtraMessageInfo extends BaseToStringInfo {
	...
	private BooleanEnum cancelAlert;//是否取消弹框
	...
	public BooleanEnum getCancelAlert() {
		return cancelAlert;
	}
	
	public void setCancelAlert(BooleanEnum cancelAlert) {
