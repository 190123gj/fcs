 ...
 * 2016-3-10 下午5:58:07
 */
public class FInvestigationCsRationalityReviewOrder extends FInvestigationBaseOrder{
...
//	private List<InvestigationFinancialKpiOrder> kpies;
	...
	private List<FInvestigationCsRationalityReviewGuarantorOrder> guarantors; //保证人
    //========== getters and setters ==========
	...
	public List<FInvestigationCsRationalityReviewGuarantorOrder> getGuarantors() {
		return this.guarantors;
	}

	public void setGuarantors(List<FInvestigationCsRationalityReviewGuarantorOrder> guarantors) {
