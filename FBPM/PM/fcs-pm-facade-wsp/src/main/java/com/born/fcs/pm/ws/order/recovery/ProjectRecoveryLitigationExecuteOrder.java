...
public class ProjectRecoveryLitigationExecuteOrder extends ProcessOrder {
	...
	//拍卖
	private List<ProjectRecoveryLitigationExecuteStuffOrder> projectRecoveryLitigationExecuteStuffAuctionOrder;
	//变卖
	private List<ProjectRecoveryLitigationExecuteStuffOrder> projectRecoveryLitigationExecuteStuffSelloffOrder;
	...
	public List<ProjectRecoveryLitigationExecuteStuffOrder> getProjectRecoveryLitigationExecuteStuffAuctionOrder() {
		return this.projectRecoveryLitigationExecuteStuffAuctionOrder;
	}
	
	public void setProjectRecoveryLitigationExecuteStuffAuctionOrder(	List<ProjectRecoveryLitigationExecuteStuffOrder> projectRecoveryLitigationExecuteStuffAuctionOrder) {
		this.projectRecoveryLitigationExecuteStuffAuctionOrder = projectRecoveryLitigationExecuteStuffAuctionOrder;
	}
	
	public List<ProjectRecoveryLitigationExecuteStuffOrder> getProjectRecoveryLitigationExecuteStuffSelloffOrder() {
		return this.projectRecoveryLitigationExecuteStuffSelloffOrder;
	}
	
	public void setProjectRecoveryLitigationExecuteStuffSelloffOrder(	List<ProjectRecoveryLitigationExecuteStuffOrder> projectRecoveryLitigationExecuteStuffSelloffOrder) {
		this.projectRecoveryLitigationExecuteStuffSelloffOrder = projectRecoveryLitigationExecuteStuffSelloffOrder;
	}
