 ...
 */
public class ProjectRiskReportInfo extends BaseToStringInfo {
    ...
    private List<ProjectRiskReportCompDetailInfo> detailInfos;
    ...
    public List<ProjectRiskReportCompDetailInfo> getDetailInfos() {
        return detailInfos;
    }

    public void setDetailInfos(List<ProjectRiskReportCompDetailInfo> detailInfos) {
