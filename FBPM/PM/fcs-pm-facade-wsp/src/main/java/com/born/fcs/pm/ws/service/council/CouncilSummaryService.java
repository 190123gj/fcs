...
public interface CouncilSummaryService {
	 ...
	 * @return
	 */
	FormBaseResult saveRiskHandleCs(FCouncilSummaryRiskHandleOrder order);
	 ...
	 * @return
	 */
	FCouncilSummaryRiskHandleInfo queryRiskHandleCsByHandleId(long handleId);
	 ...
	 * @return
	 */
	FCouncilSummaryRiskHandleInfo queryRiskHandleCsByRedoProjectCode(String redoProjectCode);
	 ...
	 * @return
	 */
	QueryBaseBatchResult<CouncilSummaryRiskHandleInfo> queryApprovalRiskHandleCs(	CouncilSummaryRiskHandleQueryOrder order);
	 ...
	 * @return
	 */
	FcsBaseResult submitSummary(CouncilSummarySubmitOrder order);
}