...
public class UserDetailsServiceProxy implements com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsService {
  private String _endpoint = null;
  private com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsService userDetailsService = null;
  ...
  private void _initUserDetailsServiceProxy() {
    try {
      userDetailsService = (new com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsServiceImplServiceLocator()).getUserDetailsServiceImplPort();
  ...
  public com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsService getUserDetailsService() {
    if (userDetailsService == null)
      _initUserDetailsServiceProxy();
