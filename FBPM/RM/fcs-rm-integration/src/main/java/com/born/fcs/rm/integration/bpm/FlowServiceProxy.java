...
public class FlowServiceProxy implements com.born.fcs.rm.integration.bpm.FlowService {
  private String _endpoint = null;
  private com.born.fcs.rm.integration.bpm.FlowService flowService = null;
  ...
  private void _initFlowServiceProxy() {
    try {
      flowService = (new com.born.fcs.rm.integration.bpm.FlowServiceImplServiceLocator()).getFlowServiceImplPort();
      if (flowService != null) {
        if (_endpoint != null)
  ...
  public com.born.fcs.rm.integration.bpm.FlowService getFlowService() {
    if (flowService == null)
      _initFlowServiceProxy();
    return flowService;
  }
