...
public class UserDetailsServiceImplServiceLocator extends org.apache.axis.client.Service implements com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsServiceImplService {
    ...
    public com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsService getUserDetailsServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsService getUserDetailsServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub _stub = new com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub _stub = new com.born.fcs.rm.integration.bpm.service.client.user.UserDetailsServiceImplServiceSoapBindingStub(new java.net.URL(UserDetailsServiceImplPort_address), this);
                _stub.setPortName(getUserDetailsServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
