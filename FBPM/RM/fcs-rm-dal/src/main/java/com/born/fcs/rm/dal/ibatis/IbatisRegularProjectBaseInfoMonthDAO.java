...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.rm.dal.daointerface.RegularProjectBaseInfoMonthDAO</tt>.
 *
...
public class IbatisRegularProjectBaseInfoMonthDAO extends SqlMapClientDaoSupport implements RegularProjectBaseInfoMonthDAO {
	/**
    ...
    public String insert(RegularProjectBaseInfoMonthDO regularProjectBaseInfoMonth) throws DataAccessException {
    	if (regularProjectBaseInfoMonth == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-REGULAR-PROJECT-BASE-INFO-MONTH-INSERT", regularProjectBaseInfoMonth);

        return regularProjectBaseInfoMonth.getReportDate();
    }
    ...
    public int update(RegularProjectBaseInfoMonthDO regularProjectBaseInfoMonth) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-REGULAR-PROJECT-BASE-INFO-MONTH-UPDATE", regularProjectBaseInfoMonth);
    }
    ...
    public RegularProjectBaseInfoMonthDO findByPrimary(String reportDate, String projectCode) throws DataAccessException {
        ...
        return (RegularProjectBaseInfoMonthDO) getSqlMapClientTemplate().queryForObject("MS-REGULAR-PROJECT-BASE-INFO-MONTH-FIND-BY-PRIMARY", param);
    ...
    public int deleteByReportDate(String reportDate) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-REGULAR-PROJECT-BASE-INFO-MONTH-DELETE-BY-REPORT-DATE", reportDate);
    }
