...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.rm.dal.daointerface.RegularProjectRiskInfoMonthDAO</tt>.
 *
...
public class IbatisRegularProjectRiskInfoMonthDAO extends SqlMapClientDaoSupport implements RegularProjectRiskInfoMonthDAO {
	/**
    ...
    public String insert(RegularProjectRiskInfoMonthDO regularProjectRiskInfoMonth) throws DataAccessException {
    	if (regularProjectRiskInfoMonth == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-REGULAR-PROJECT-RISK-INFO-MONTH-INSERT", regularProjectRiskInfoMonth);

        return regularProjectRiskInfoMonth.getReportDate();
    }
    ...
    public int update(RegularProjectRiskInfoMonthDO regularProjectRiskInfoMonth) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-REGULAR-PROJECT-RISK-INFO-MONTH-UPDATE", regularProjectRiskInfoMonth);
    }
    ...
    public RegularProjectRiskInfoMonthDO findByPrimary(String reportDate, String projectCode) throws DataAccessException {
        ...
        return (RegularProjectRiskInfoMonthDO) getSqlMapClientTemplate().queryForObject("MS-REGULAR-PROJECT-RISK-INFO-MONTH-FIND-BY-PRIMARY", param);
    ...
    public int deleteByReportDate(String reportDate) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-REGULAR-PROJECT-RISK-INFO-MONTH-DELETE-BY-REPORT-DATE", reportDate);
    }
