...
public class EvaluetingListAuditInfo extends FormInfo {
	private static final long serialVersionUID = -1899143819578666337L;
	/** 主键 */
	private long id;
	...
	public String toString() {
		...
		builder.append("EvaluetingListAuditInfo [id=");
		builder.append(id);
