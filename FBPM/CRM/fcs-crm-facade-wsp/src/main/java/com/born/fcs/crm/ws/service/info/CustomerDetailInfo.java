...
public class CustomerDetailInfo extends CustomerBaseInfo {
	
	private static final long serialVersionUID = -3568960425879747216L;
	/** 企业客户 - 获得的资质证书 */
	List<CompanyQualificationInfo> companyQualification;
	/** 企业客户 - 公司股权结构 */
	List<CompanyOwnershipStructureInfo> companyOwnershipStructure;
	/** 个人客户 - 旗下公司信息 */
	List<PersonalCompanyInfo> reqList;
	/** 去年评级 */
	...
	public List<PersonalCompanyInfo> getReqList() {
		return this.reqList;
	}
	
	public void setReqList(List<PersonalCompanyInfo> reqList) {
	...
	/** 是否个人客户 */
	public boolean isPersional() {
		if ("PERSIONAL".equals(getCustomerType())) {
			return true;
		}
		return false;
	...
	public boolean isEnterprise() {
		if ("ENTERPRISE".equals(getCustomerType())) {
			return true;
		}
		return false;
	...
	public boolean isCanChange() {
		if (ProjecteStatusEnum.IS.code().equals(getProjectStatus())) {
			return true;
		}
		return false;
	...
	public String toString() {
		...
		builder.append("CustomerDetailInfo [companyQualification=");
