 ...
 * 评价基础配置信息
 * */
public class EvaluatingBaseSetInfo implements Serializable {
	
	private static final long serialVersionUID = 2965451258239172979L;
	...
	public String toString() {
		...
		builder.append("EvaluatingBaseSetInfo [id=");
		builder.append(id);
		builder.append(", level1Id=");
		builder.append(level1Id);
		builder.append(", level1Name=");
		builder.append(level1Name);
		builder.append(", level1Description=");
		builder.append(level1Description);
		builder.append(", level1Score=");
		builder.append(level1Score);
		builder.append(", level2Id=");
		builder.append(level2Id);
		builder.append(", level2Name=");
		builder.append(level2Name);
		builder.append(", level2Description=");
		builder.append(level2Description);
		builder.append(", level2Score=");
		builder.append(level2Score);
		builder.append(", level3Id=");
		builder.append(level3Id);
		builder.append(", level3Name=");
		builder.append(level3Name);
		builder.append(", level3Description=");
		builder.append(level3Description);
		builder.append(", level3Score=");
		builder.append(level3Score);
		builder.append(", level4Id=");
		builder.append(level4Id);
		builder.append(", level4Name=");
		builder.append(level4Name);
		builder.append(", level4Description=");
		builder.append(level4Description);
		builder.append(", level4Score=");
		builder.append(level4Score);
		builder.append(", evaluatingContent=");
		builder.append(evaluatingContent);
		builder.append(", evaluatingResult=");
		builder.append(evaluatingResult);
		builder.append(", score=");
		builder.append(score);
		builder.append(", standardValue=");
		builder.append(standardValue);
		builder.append(", compareMethod=");
		builder.append(compareMethod);
		builder.append(", compareMethod2=");
		builder.append(compareMethod2);
		builder.append(", compareMethod3=");
		builder.append(compareMethod3);
		builder.append(", compareStandardValue=");
		builder.append(compareStandardValue);
		builder.append(", evaluatingStandardValue=");
		builder.append(evaluatingStandardValue);
		builder.append(", compareEvaluatingStandardValue=");
		builder.append(compareEvaluatingStandardValue);
		...
		builder.append(rawUpdateTime);
		builder.append(", orderNum1=");
		builder.append(orderNum1);
		builder.append(", orderNum2=");
		builder.append(orderNum2);
		builder.append(", orderNum3=");
		builder.append(orderNum3);
		builder.append(", orderNum4=");
		builder.append(orderNum4);
		builder.append("]");
