...
public class ChannalInfo implements Serializable {
	...
	private static final long serialVersionUID = 7475832542532034111L;
	/** 联系人 */
	...
	/** 授信到期是否已提醒 */
	private final String isRemind = BooleanEnum.NO.code();
	/** 历史数据 */
	private final String isHistory = BooleanEnum.NO.code();
	/** 是否续签数据 */
	private final String isXuQian = BooleanEnum.NO.code();
	...
	public String toString() {
		...
		builder.append("ChannalInfo [listData=");
