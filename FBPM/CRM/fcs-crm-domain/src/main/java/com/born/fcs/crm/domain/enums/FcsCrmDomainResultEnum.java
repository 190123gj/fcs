 ...
 */
package com.born.fcs.crm.domain.enums;
 ...
 *
 */
public enum FcsCrmDomainResultEnum {
	 ...
	 * @param message
	 */
	private FcsCrmDomainResultEnum(String code, String message) {
		this.code = code;
	 ...
	 */
	public static FcsCrmDomainResultEnum getByCode(String code) {
		for (FcsCrmDomainResultEnum _enum : values()) {
	 ...
	 */
	public List<FcsCrmDomainResultEnum> getAllEnum() {
		List<FcsCrmDomainResultEnum> list = new ArrayList<FcsCrmDomainResultEnum>();
		for (FcsCrmDomainResultEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
