...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.crm.dal.daointerface.EvaluatingFinancialSetDAO</tt>.
 *
...
public class IbatisEvaluatingFinancialSetDAO extends SqlMapClientDaoSupport implements EvaluatingFinancialSetDAO {
	/**
    ...
    public long insert(EvaluatingFinancialSetDO evaluatingFinancialSet) throws DataAccessException {
    	if (evaluatingFinancialSet == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-EVALUATING-FINANCIAL-SET-INSERT", evaluatingFinancialSet);

        return evaluatingFinancialSet.getId();
    }
    ...
    public int deleteById(long id) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-EVALUATING-FINANCIAL-SET-DELETE-BY-ID", param);
    }
    ...
    public int update(EvaluatingFinancialSetDO evaluatingFinancialSet) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-EVALUATING-FINANCIAL-SET-UPDATE", evaluatingFinancialSet);
    }
    ...
    public List<EvaluatingFinancialSetDO> findWithCondition(EvaluatingFinancialSetDO evaluatingFinancialSet) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-EVALUATING-FINANCIAL-SET-FIND-WITH-CONDITION", evaluatingFinancialSet);
