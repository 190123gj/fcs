...
public class FormMessageTempleteServiceClient extends ClientAutowiredBaseService implements
																				FormMessageTempleteService {
	@Autowired
	FormMessageTempleteService formMessageTempleteWebService;
	...
	@Override
	public QueryBaseBatchResult<FormMessageTempleteInfo> queryPage(	final FormMessageTempleteQueryOrder order) {
	...
	@Override
	public FormMessageTempleteInfo findByFormCodeAndType(final FormCodeEnum formCode,
															final FormMessageTypeEnum type) {
		return callInterface(new CallExternalInterface<FormMessageTempleteInfo>() {
			
			@Override
			public FormMessageTempleteInfo call() {
				return formMessageTempleteWebService.findByFormCodeAndType(formCode, type);
			}
		});
	}
	...
	public FormMessageTempleteInfo findByTempleteId(final long templeteId) {
		return callInterface(new CallExternalInterface<FormMessageTempleteInfo>() {
			...
			@Override
			public FormMessageTempleteInfo call() {
				return formMessageTempleteWebService.findByTempleteId(templeteId);
			}
		});
	}
	...
	public FcsBaseResult deleteByTempleteId(final long templeteId) {
		return callInterface(new CallExternalInterface<FcsBaseResult>() {
			...
			@Override
			public FcsBaseResult call() {
				return formMessageTempleteWebService.deleteByTempleteId(templeteId);
			}
		});
	}
