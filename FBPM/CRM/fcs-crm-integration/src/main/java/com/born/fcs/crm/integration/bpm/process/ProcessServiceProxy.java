...
public class ProcessServiceProxy implements com.born.fcs.crm.integration.bpm.process.ProcessService {
  private String _endpoint = null;
  private com.born.fcs.crm.integration.bpm.process.ProcessService processService = null;
  ...
  private void _initProcessServiceProxy() {
    try {
      processService = (new com.born.fcs.crm.integration.bpm.process.ProcessServiceImplServiceLocator()).getProcessServiceImplPort();
  ...
  public com.born.fcs.crm.integration.bpm.process.ProcessService getProcessService() {
    if (processService == null)
      _initProcessServiceProxy();
