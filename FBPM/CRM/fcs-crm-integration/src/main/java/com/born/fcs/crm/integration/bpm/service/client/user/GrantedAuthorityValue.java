...
public class GrantedAuthorityValue implements java.io.Serializable {
	...
	public GrantedAuthorityValue(java.lang.String authority) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof GrantedAuthorityValue))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.authority == null && other.getAuthority() == null) || (this.authority != null && this.authority
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		GrantedAuthorityValue.class, true);
