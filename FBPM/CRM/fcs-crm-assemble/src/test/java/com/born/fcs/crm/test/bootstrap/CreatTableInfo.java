package com.born.fcs.crm.test.bootstrap;
...
public class CreatTableInfo {
	...
	private static final String sql_name = "born_fcs_crm";//库名
	...
	public static void main(String[] args) {
		//设置表信息
		String table_Name = "list_data_save";//目标表名
		String[] money_clumn = { "total_asset", "net_asset", "sales_proceeds_last_year",
								"total_profit_last_year", "sales_proceeds_this_year",
								"total_profit_this_year", "register_capital", "actual_capital" };//金额字段列名
