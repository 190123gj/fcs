 ...
 */
package com.born.fcs.rm.domain.context;
 ...
 */
public class FcsPmDomainContext<T extends Order> implements Serializable {
	...
	public FcsPmDomainContext(Date sysDate, T target,
