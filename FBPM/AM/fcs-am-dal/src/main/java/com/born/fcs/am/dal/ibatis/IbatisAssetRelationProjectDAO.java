...
/**
 * An ibatis based implementation of dao interface <tt>com.born.fcs.am.dal.daointerface.AssetRelationProjectDAO</tt>.
 *
...
public class IbatisAssetRelationProjectDAO extends SqlMapClientDaoSupport implements AssetRelationProjectDAO {
	/**
    ...
    public long insert(AssetRelationProjectDO assetRelationProject) throws DataAccessException {
    	if (assetRelationProject == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-ASSET-RELATION-PROJECT-INSERT", assetRelationProject);

        return assetRelationProject.getId();
    }
    ...
    public int update(AssetRelationProjectDO assetRelationProject) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-ASSET-RELATION-PROJECT-UPDATE", assetRelationProject);
    }
    ...
    public AssetRelationProjectDO findById(long id) throws DataAccessException {
        ...
        return (AssetRelationProjectDO) getSqlMapClientTemplate().queryForObject("MS-ASSET-RELATION-PROJECT-FIND-BY-ID", param);
    ...
    public AssetRelationProjectDO findByAssetsIdAndProjectCodeAndStatusAndFirst(long assetsId, String projectCode, String assetsStatus, String assetFirstType) throws DataAccessException {
        ...
        param.put("assetsStatus", assetsStatus);
        param.put("assetFirstType", assetFirstType);

        return (AssetRelationProjectDO) getSqlMapClientTemplate().queryForObject("MS-ASSET-RELATION-PROJECT-FIND-BY-ASSETS-ID-AND-PROJECT-CODE-AND-STATUS-AND-FIRST", param);
    ...
    public List<AssetRelationProjectDO> findByAssetsIdAndProjectCodeAndStatus(long assetsId, String projectCode, String assetsStatus) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-ASSET-RELATION-PROJECT-FIND-BY-ASSETS-ID-AND-PROJECT-CODE-AND-STATUS", param);
    ...
    public List<AssetRelationProjectDO> findByAssetsId(long assetsId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().queryForList("MS-ASSET-RELATION-PROJECT-FIND-BY-ASSETS-ID", param);
    ...
    public List<AssetRelationProjectDO> findByCustomerId(long customerId) throws DataAccessException {
        Long param = new Long(customerId);

        return getSqlMapClientTemplate().queryForList("MS-ASSET-RELATION-PROJECT-FIND-BY-CUSTOMER-ID", param);
    ...
    public int deleteByProjectCode(String projectCode) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-ASSET-RELATION-PROJECT-DELETE-BY-PROJECT-CODE", projectCode);
    }
    ...
    public int deleteById(long id) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-ASSET-RELATION-PROJECT-DELETE-BY-ID", param);
    }
    ...
    public List<AssetRelationProjectDO> findByCondition(AssetRelationProjectDO assetRelationProject, String sortCol, String sortOrder, long limitStart, long pageSize) throws DataAccessException {
        ...
        param.put("assetRelationProject", assetRelationProject);
        param.put("sortCol", sortCol);
        param.put("sortOrder", sortOrder);
        param.put("limitStart", new Long(limitStart));
        param.put("pageSize", new Long(pageSize));

        return getSqlMapClientTemplate().queryForList("MS-ASSET-RELATION-PROJECT-FIND-BY-CONDITION", param);
    ...
    public long findByConditionCount(AssetRelationProjectDO assetRelationProject) throws DataAccessException {
	    ...
	    Long retObj = (Long) getSqlMapClientTemplate().queryForObject("MS-ASSET-RELATION-PROJECT-FIND-BY-CONDITION-COUNT", assetRelationProject);
