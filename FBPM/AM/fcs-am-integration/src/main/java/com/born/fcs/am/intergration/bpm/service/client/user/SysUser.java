...
public class SysUser extends BaseModel implements java.io.Serializable {
	...
	public SysUser(	java.lang.Long createBy,
					...
					com.born.fcs.am.intergration.bpm.service.client.user.GrantedAuthorityValue[] authorities,
	 ...
	 * @return authorities
	 */
	public com.born.fcs.am.intergration.bpm.service.client.user.GrantedAuthorityValue[] getAuthorities() {
		return authorities;
	}
	 ...
	 * @param authorities
	 */
	public void setAuthorities(	com.born.fcs.am.intergration.bpm.service.client.user.GrantedAuthorityValue[] authorities) {
		this.authorities = authorities;
	}
	
	public com.born.fcs.am.intergration.bpm.service.client.user.GrantedAuthorityValue getAuthorities(	int i) {
		return this.authorities[i];
	}
	
	public void setAuthorities(	int i,
								com.born.fcs.am.intergration.bpm.service.client.user.GrantedAuthorityValue _value) {
