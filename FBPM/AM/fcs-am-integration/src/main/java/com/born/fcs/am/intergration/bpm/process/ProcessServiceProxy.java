...
public class ProcessServiceProxy implements com.born.fcs.am.intergration.bpm.process.ProcessService {
  private String _endpoint = null;
  private com.born.fcs.am.intergration.bpm.process.ProcessService processService = null;
  ...
  private void _initProcessServiceProxy() {
    try {
      processService = (new com.born.fcs.am.intergration.bpm.process.ProcessServiceImplServiceLocator()).getProcessServiceImplPort();
  ...
  public com.born.fcs.am.intergration.bpm.process.ProcessService getProcessService() {
    if (processService == null)
      _initProcessServiceProxy();
