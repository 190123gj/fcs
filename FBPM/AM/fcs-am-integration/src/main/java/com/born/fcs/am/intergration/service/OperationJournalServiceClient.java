...
public class OperationJournalServiceClient extends ClientAutowiredBaseService
		implements OperationJournalService, InitializingBean {
	...
	@Override
	public OperationJournalServiceResult addOperationJournalInfo(
			final OperationJournalAddOrder operationJournalAddOrder) {
		return callInterface(new CallExternalInterface<OperationJournalServiceResult>() {

			@Override
			public OperationJournalServiceResult call() {
				return operationJournalWebService
	...
	@Override
	public QueryBaseBatchResult<OperationJournalInfo> queryOperationJournalInfo(
			final OperationJournalQueryOrder queryOrder) {
