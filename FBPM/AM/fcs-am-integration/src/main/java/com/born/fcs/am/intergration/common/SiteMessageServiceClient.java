...
@Service("siteMessageServiceClient")
public class SiteMessageServiceClient extends ClientAutowiredBaseService
	...
	@Override
	public QueryBaseBatchResult<MessageReceivedInfo> findReceviedMessage(
			final QueryReceviedMessageOrder order) {
	...
	@Override
	public QueryBaseBatchResult<MessageReceivedInfo> loadUnReadMyMessage(
			final long userId) {
		return callInterface(new CallExternalInterface<QueryBaseBatchResult<MessageReceivedInfo>>() {
	...
	@Override
	public QueryBaseBatchResult<MessageInfo> findMessage(
			final QueryMessageOrder order) {
	...
	@Override
	public MessageResult deleteReceivedMessageInfo(
			final MyMessageOrder myMessageOrder) {
		return callInterface(new CallExternalInterface<MessageResult>() {

			@Override
			public MessageResult call() {
				return siteMessageWebService
						.deleteReceivedMessageInfo(myMessageOrder);
			}
		});
	}
	...
	@Override
	public MessageResult readMessageAndUpStatus(
			final MyMessageOrder myMessageOrder) {
		return callInterface(new CallExternalInterface<MessageResult>() {
			...
			public MessageResult call() {
				return siteMessageWebService
						.readMessageAndUpStatus(myMessageOrder);
			}
		});
	}
	...
	public FcsBaseResult updateReceivedMessageStatus(final long userId,
		...
		return callInterface(new CallExternalInterface<FcsBaseResult>() {
			...
			@Override
			public FcsBaseResult call() {
				return siteMessageWebService.updateReceivedMessageStatus(
						userId, status);
			}
		});
	}
