...
public class ProjectServiceClient extends ClientAutowiredBaseService implements
		ProjectService {

	@Override
	public QueryBaseBatchResult<ProjectInfo> queryProject(
			final ProjectQueryOrder projectQueryOrder) {
	...
	@Override
	public QueryBaseBatchResult<ProjectApprovaInfo> queryProjectApproval(
			final ProjectApprovalQueryOrder order) {
	...
	@Override
	public ProjectInfo queryByCode(final String projectCode,
	...
	@Override
	public ProjectResult changeProjectStatus(
			final ChangeProjectStatusOrder order) {
		return callInterface(new CallExternalInterface<ProjectResult>() {
	...
	@Override
	public ProjectSimpleDetailInfo querySimpleDetailInfo(
	...
	@Override
	public QueryBaseBatchResult<ProjectSimpleDetailInfo> queryProjectSimpleDetail(
			final ProjectQueryOrder projectQueryOrder) {
		return callInterface(new CallExternalInterface<QueryBaseBatchResult<ProjectSimpleDetailInfo>>() {
			...
			public QueryBaseBatchResult<ProjectSimpleDetailInfo> call() {
				return projectWebService
						.queryProjectSimpleDetail(projectQueryOrder);
			}
		});
	}
	...
	public int updateIsContinueByProjectCode(final String projectCode) {
		return callInterface(new CallExternalInterface<Integer>() {
			...
			public Integer call() {
				return projectWebService
						.updateIsContinueByProjectCode(projectCode);
			}
		});
	}
