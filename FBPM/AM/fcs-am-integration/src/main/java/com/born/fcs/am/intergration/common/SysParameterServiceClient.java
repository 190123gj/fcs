...
public class SysParameterServiceClient extends ClientAutowiredBaseService
		implements SysParameterService, InitializingBean {
	...
	@Override
	public FcsBaseResult updateSysParameterValueDO(
			final SysParamOrder sysParamOrder) {
		return callInterface(new CallExternalInterface<FcsBaseResult>() {
			@Override
			public FcsBaseResult call() {
				FcsBaseResult baseResult = new FcsBaseResult();
				baseResult = sysParameterWebService
						.updateSysParameterValueDO(sysParamOrder);
	...
	@Override
	public FcsBaseResult insertSysParameterValueDO(
			final SysParamOrder sysParamOrder) {
		return callInterface(new CallExternalInterface<FcsBaseResult>() {
			@Override
			public FcsBaseResult call() {
				FcsBaseResult baseResult = new FcsBaseResult();
				baseResult = sysParameterWebService
						.insertSysParameterValueDO(sysParamOrder);
	...
	@Override
	public QueryBaseBatchResult<SysParamInfo> querySysPram(
			final SysParamQueryOrder sysParamQueryOrder) {
