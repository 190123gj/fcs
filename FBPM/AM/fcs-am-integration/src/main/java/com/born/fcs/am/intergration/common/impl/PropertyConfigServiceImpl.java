package com.born.fcs.am.intergration.common.impl;
...
public class PropertyConfigServiceImpl implements PropertyConfigService {
	...
	@Value("${born.bmp.service.endpoint}")
	private String bornBmpServiceEndpoint;

	@Value("${born.bmp.contextpath}")
	...
	public String getBmpRootUrl() {
		if (Env.isDev()) {
			return sysParameterServiceClient
					.getSysParameterValue(SysParamEnum.SYS_PARAM_FACE_WEB_URL
							.code())
					+ "/" + bornBmpContextpath;
		} else {
