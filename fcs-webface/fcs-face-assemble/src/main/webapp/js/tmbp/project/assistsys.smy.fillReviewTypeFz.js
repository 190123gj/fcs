define(function(require, exports, module) {
	...
	var _form = $('#form'),
		...
		maxlength50Rules = _form.requiredRulesSharp('assetRemark,content,overview,projectOverview,chargeRemark,remark,assetType,ownershipName,evaluationPrice,pledgeRate,other,pathName_COUNTER_GUARANTEE,id,guaranteeAmountStr,tabId,spId,summaryId,projectCode,cancel,isRepayEqual,checkIndex,checkStatus,formId,formCode,initiatorId,initiatorAccount,processFlag,isMaximumAmount,upBp,downBp,assetLiabilityRatio,upRate,downRate', _allWhetherNull['boll'], {}, function(rules, name) {
			rules[name] = {
				maxlength: 50,
				messages: {
					maxlength: '已超出50字'
