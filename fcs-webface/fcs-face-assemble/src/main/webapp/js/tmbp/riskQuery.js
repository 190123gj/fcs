...
define(function (require, exports, module) {
    ...
    initRiskQuery.prototype.getAllInfo = function (xx, sx, xs, fn) {
        ...
        if (!!!self.DomName.value || (!!!self.DomLicenseNo.value && !!!self.DomOrgCode.value && !!!self.DomCertNo.value)) {
            Y.alert('提示', '请输入客户名称及证件号码')
            return
        }
        ...
        $.when(self.getXX(xx))
            ...
            .then(function (res) {
                ...
                if (res.success) {
                    ...
                    _s = '<p class="fn-mr20 fn-mb10 fn-tal">客户名称：' + self.DomName.value + '&emsp;证件号码：' + (self.DomCertNo.value || self.DomLicenseNo.value) + '&emsp;省份：' + (res.data[0] || {}).area + ((res.data[0] || {}).sex ? ('&emsp;性别：' + res.data[0].sex) : '') + '</p><div class="fn-w700"><table class="m-table m-table-list fn-tac">' + _thead + '<tbody>' + _tbody + '</tbody></table></div>';
            ...
            .then(function (res) {
                ...
                if (res.success) {
                    ...
                    _s = '<p class="fn-mr20 fn-mb10 fn-tal">客户名称：' + self.DomName.value + '&emsp;证件号码：' + (self.DomCertNo.value || self.DomLicenseNo.value) + '</p><div class="fn-mr20"><div class="fn-mr20 fn-w700"><table class="m-table m-table-list fn-tac">' + _thead + '<tbody>' + _tbody + '</tbody></table></div>';
