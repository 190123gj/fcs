define(function (require, exports, module) {
    ...
    publicOPN.prototype = {
        ...
        init: function () {
            ...
            if (_examineRecordId) {
                ...
                $body.on('click', '.fnAuditMoreExamineRecord', function () {
                    ...
                    $('body').Y('Window', {
                        content: creatMoreApprovalOpinion(_txt),
                        contentClone: true,
                        key: 'modalwnd',
                        title: '审批意见'
                    });
            ...
            self.$back = $('<ul class="ui-tool"></ul>').html('<li><a style="display: none;" class="fn-hide feed" id="fnFooterGoBack" href="javascript: void(0);">返回<br>顶部</a></li>')

            if (!$_GLOBAL.isApp) {
                $('body').append(self.$back);
            }
        ...
        creatLi: function (obj) {
            ...
            // 如果没有，添加回调
            if (obj.url) {
                _html = '<li><a href="' + obj.url + '" target="_blank">' + obj.name + '</a></li>';
            } else {
    ...
    function creatAmendRecord(obj) {
        ...
        var _tpl = [
            ...
            '        <div class="m-modal-title"><span class="m-modal-close close">&times;</span><span class="title">查看修改记录</span></div>',
            ...
            '            <a href="javascript:void(0);" class="ui-btn ui-btn-fill ui-btn-fill-big ui-btn-gray close">关闭</a>',
            '        </div>',
            '    </div>',
            '</div>'
        ].join('');
    ...
    function creatProjectApproval(obj) {
        ...
        var _tpl = [
            ...
            '    <div class="m-modal-overlay"></div>',
            '    <div class="m-modal m-modal-default">',
            '        <div class="m-modal-title"><span class="m-modal-close close">&times;</span><span class="title">查看项目批复</span></div>',
            '        <div class="m-modal-body"><div class="m-modal-body-box"><div class="m-modal-body-inner">',
            '            <div class="m-item">',
    ...
    function creatContractList(obj) {
        ...
        var _tpl = [
            ...
            '    <div class="m-modal-overlay"></div>',
            '    <div class="m-modal m-modal-default">',
            '        <div class="m-modal-title"><span class="m-modal-close close">&times;</span><span class="title">查看合同</span></div>',
            '        <div class="m-modal-body"><div class="m-modal-body-box"><div class="m-modal-body-inner">',
            '            <div class="fn-blank10"></div>',
            '            <table class="m-table fn-tac">',
            '                <thead>',
    ...
    function creatExamineRecord(obj) {
        ...
        var _tpl = [
            ...
            '    <div class="m-modal-overlay"></div>',
            '    <div class="m-modal m-modal-default">',
            '        <div class="m-modal-title"><span class="m-modal-close close">&times;</span><span class="title">查看审批记录</span></div>',
            '        <div class="m-modal-body"><div class="m-modal-body-box"><div class="m-modal-body-inner">',
            '            <div class="fn-blank10"></div>',
            '            <table class="m-table fn-tac">',
            '                <thead>',
