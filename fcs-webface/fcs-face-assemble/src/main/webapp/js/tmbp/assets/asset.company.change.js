    ...
    _getList.init({
        ...
        tpl: {
            tbody: ['{{each pageList as item i}}',
                ...
                '        <td width="100" class="item" id="{{item.companyName}}">{{item.companyName}}</td>',
        ...
        callback: function($a) {
            ...
            document.getElementById('workSituation2').innerText = $a.attr('workSituation');
            document.getElementById('attachment2').innerText = $a.attr('attachment');
            document.getElementById('technicalLevel2').innerText = $a.attr('technicalLevel');
            document.getElementById('evaluationEfficiency2').innerText = $a.attr('evaluationEfficiency');
            document.getElementById('cooperationSituation2').innerText = $a.attr('cooperationSituation');
            document.getElementById('serviceAttitude2').innerText = $a.attr('serviceAttitude');
        }
    });
...
//                        });
            ...
            event: function() {
                ...
                if (!_isPass) {
                    ...
                    if ($('#companyId').val() == '' || $('#companyId').val() == 'companyName1') {
                        ...
                        var newName = $('#companyName1').val(),
                            newNameAll = newName.split(','),
                            textAll = companyName.split(','),
                            j,i,k = 0 ;

                        for( j = 0 ; j < newNameAll.length ; j++ ){

                            var newNameVal = newNameAll[j];

                            for( i = 0 ; i < textAll.length ; i++ ){

                                var textAllVal = textAll[i];

                                if( textAllVal == newNameVal ){
    ...
    $('.selectNav a').click(function(){
        ...
        if(appointWay.val() == 'APPOINT'){
            
            $('.fnAppointCompany').find('input').each(function(index, el) {
