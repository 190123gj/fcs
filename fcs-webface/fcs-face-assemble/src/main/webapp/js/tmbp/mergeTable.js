define(function (require, exports, module) {
    ...
    var mergeTable = require('zyw/mergeTable');
        ...
        obj: '.demandMerge',//需要合并的td(text类型)

        objVal: '.demandMerge',//需要合并的td(input、select类型)
        ...
        bridge:false,//是否允许后级跨前级行默认为false
        transform: {
    ...
    */
    ...
    mergeTable.prototype = {
        ...
        init: function (objList) {
            ...
            this.bridge = objList && objList.bridge;
            this.executeInit();
        ...
        execute: function (thisObjse, jusdese) { //初始合并表格
            ...
            thisObjse.each(function (index, el) {
                ...
                $parentPrev.each(function (index, el) {
                    ...
                    if (($prevPrice == $price) && (self.bridge || ((prevLength) ? prevRowspan > rowspan : true))) {
