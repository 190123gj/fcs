...
define(function (require, exports, module) {
    ...
    var ccName = $("#fnBusiLicenseNoCopy")
    var temp = ''
    ...
    if (isqb) {
        ...
        ccName.change(function () {
            cName.val(ccName.val())
            cName.trigger('change')
        })

        cName.change(function () {
            ccName.val(cName.val())
        })
        ...
        function checkIfChecked() {
            ...
            if($('#isThreeBtn').prop('checked') || $('#isThreeBtn').attr('checked') === 'checked') {
                ...
                ccName.removeAttr('readonly')

            } else {

                cName.attr('readonly','true')
                ccName.attr('readonly','true')
            }
    ...
    //移除validate
    setTimeout(function () {
        var removeObj = 'certType,address,legalPersionCertNo'.split(',')
