define(function (require, exports, module) {
    ...
    $('body').on('change', '#selectAddress select', function () {
    ...
    }).on('change', '#selectAddress select:not(:last)', function () {
        var _this = $(this);
        //当不是最后一个的时候，把当前后面的下级删了
        _this.nextAll('select').remove();
    }).on('change', '#selectAddress select:first', function () {
    ...
    function addressRestore(arr) {
        ...
        function getSelect(obj) {
            ...
            $.getJSON('/baseDataLoad/region.json?edit=true', {
