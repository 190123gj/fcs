...
public class PakoGzipUtils {
	...
	/**
	 * @param jsUriStr
	 * :字符串类型为：%1F%C2%8B%08%00%00%00%00%00%00%03%C2%B3)%C2%B0K%2CNI%03c%20i%C2%
	 * A3_%60%C3%
	 * 87e%03%11%23%C2%82%0Dc%C2%A6%25%C3%82XH%C3%B2jyI%C3%85%05%C3%96%60%1E%00%17%C2%8E%3Dvf%00%0
	 * 0 % 0 0
	 * @return 生成正常字符串
	 * @throws IOException
	 */
	 ...
	 * @return
	 * 生成字符串类型为：%1F%C2%8B%08%00%00%00%00%00%00%03%C2%B3)%C2%B0K%2CNI%03c%20i%C2%
	 * A3_%60%C3%
	 * 87e%03%11%23%C2%82%0Dc%C2%A6%25%C3%82XH%C3%B2jyI%C3%85%05%C3%96%60%1E%00%17%C2%8E%3Dvf%00%0
	 * 0 % 0 0
	 * @throws IOException
