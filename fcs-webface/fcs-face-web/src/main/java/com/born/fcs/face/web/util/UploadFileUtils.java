...
import com.born.fcs.pm.util.ApplicationConstant;
...
public class UploadFileUtils {
	...
	public static String getStaticFilesPdfDir() {
		return sysParameterServiceClient.getSysParameterValue(SysParamEnum.SYS_PARAM_UPLOAD_FOLDER
	...
	public static String[] getFilePath(HttpServletRequest req, String fileRoot, String dir,
		...
		String serverUrl = sysParameterServiceClient
