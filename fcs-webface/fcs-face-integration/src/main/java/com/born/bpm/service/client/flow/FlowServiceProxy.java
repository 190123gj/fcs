...
public class FlowServiceProxy implements com.born.bpm.service.client.flow.FlowService {
  private String _endpoint = null;
  private com.born.bpm.service.client.flow.FlowService flowService = null;
  ...
  private void _initFlowServiceProxy() {
    try {
      flowService = (new com.born.bpm.service.client.flow.FlowServiceImplServiceLocator()).getFlowServiceImplPort();
      if (flowService != null) {
        if (_endpoint != null)
  ...
  public com.born.bpm.service.client.flow.FlowService getFlowService() {
    if (flowService == null)
      _initFlowServiceProxy();
    return flowService;
  }
