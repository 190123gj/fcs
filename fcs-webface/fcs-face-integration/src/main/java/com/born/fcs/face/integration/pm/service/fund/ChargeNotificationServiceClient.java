...
public class ChargeNotificationServiceClient extends ClientAutowiredBaseService implements
	...
	@Override
	public ReportDataResult chargeNorificationExport(final FChargeNotificationQueryOrder order) {
		...
		return callInterface(new CallExternalInterface<ReportDataResult>() {
			...
			public ReportDataResult call()
					throws SocketTimeoutException {
				return chargeNotificationWebService.chargeNorificationExport(order);
			}
		});
	}
	@Override
	public List<FChargeNotificationInfo> queryAuditingByProjectCode(final String projectCode){
		return callInterface(new CallExternalInterface<List<FChargeNotificationInfo>>() {
			...
			@Override
			public List<FChargeNotificationInfo> call()
					throws SocketTimeoutException {
	...
	@Override
	public RefundApplicationResult queryChargeTotalAmount(final String projectCode, final FeeTypeEnum feeType) {
		return callInterface(new CallExternalInterface<RefundApplicationResult>() {

			@Override
			public RefundApplicationResult call()
					throws SocketTimeoutException {
	...
	@Override
	public FcsBaseResult recoveryEenteustedLoanPrincipalWithdrawal(final String projectCode,final String amount) {
		return callInterface(new CallExternalInterface<FcsBaseResult>() {

			@Override
			public FcsBaseResult  call()
					throws SocketTimeoutException {
				return chargeNotificationWebService.recoveryEenteustedLoanPrincipalWithdrawal(projectCode,amount);
			}
		});
	}
