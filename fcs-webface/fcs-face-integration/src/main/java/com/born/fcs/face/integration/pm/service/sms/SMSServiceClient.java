package com.born.fcs.face.integration.pm.service.sms;
...
public class SMSServiceClient extends ClientAutowiredBaseService implements
        SMSService {
    ...
    @Override
    public SMSInfo registdetailinfo(final String ename,final String linkman,final String phonenum,final String mobile,final String email,final String fax,final String address,final String postcode) {
        return callInterface(new CallExternalInterface<SMSInfo>() {

            @Override
            public SMSInfo call() {
                return sMSWebService.registdetailinfo(ename, linkman,phonenum,mobile,email,fax,address,postcode);
            }
        });
    }

    @Override
    public SMSInfo sendSMS(final String mobileNumber, final String smsContent,final String addserial) {
        return callInterface(new CallExternalInterface<SMSInfo>() {
    ...
    @Override
    public SMSInfo sendTimeSMS(final String mobileNumber,final String smsContent,final String addserial,final String sendtime) {
        return callInterface(new CallExternalInterface<SMSInfo>() {
