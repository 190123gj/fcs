...
public class WorkflowProcessLog implements Serializable {
	...
	public void setCheckStatus(int checkStatus) {
		...
		} else if (checkStatus == (int) TaskOpinion.STATUS_INTERVENE) {
			checkStatusMessage = "干预";
		} else if (checkStatus == (int) TaskOpinion.STATUS_BACK_CANCEL) {
			checkStatusMessage = "驳回取消";
		} else if (checkStatus == (int) TaskOpinion.STATUS_CHANGE_ASIGNEE) {
			checkStatusMessage = "更改执行人";
		}
	}
