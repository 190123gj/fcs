package com.born.fcs.face.integration.pm.service.projectcreditcondition;
...
public class ProjectCreditConditionServiceClient extends ClientAutowiredBaseService implements
	...
	@Override
	public QueryBaseBatchResult<CounterGuaranteeMeasuresInfo> measuresList(final FCreditConditionConfirmQueryOrder queryOrder) {
		return callInterface(new CallExternalInterface<QueryBaseBatchResult<CounterGuaranteeMeasuresInfo>>() {

			@Override
			public QueryBaseBatchResult<CounterGuaranteeMeasuresInfo> call() {
				return projectCreditConditionWebService.measuresList(queryOrder);
			}
		});
	}
